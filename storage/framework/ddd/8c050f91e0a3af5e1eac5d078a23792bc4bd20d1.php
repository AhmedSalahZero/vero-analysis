...
<?php unset($__defined_vars); ?>
                    ...
                    <li <?php $__currentLoopData = getAllDataKey($menuArr); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        class="kt-menu__item " aria-haspopup="true"><a href="<?php echo e($menuArr['link']); ?>" class="kt-menu__link ">
						<?php if(isset($menuArr['icon'])): ?>
						
						<i class="<?php echo e($menuArr['icon']); ?>"></i>
						<?php else: ?> 
						<i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
						<?php endif; ?> 
						<span class="kt-menu__link-text">
						
						<?php echo $menuArr['title']; ?>
