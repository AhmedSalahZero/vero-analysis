...
<?php endif; ?> 
                                            ...
                                            <div class="col-md-3 ">
                                                ...
                                                <div class="kt-input-icon">
                                                    <input data-max-cheque-value="0" step="1" type="numeric" value="<?php echo e(isset($model) ? $model->getTransferDays():0); ?>" name="transfer_days" class="form-control greater-than-or-equal-zero-allowed " placeholder="<?php echo e(__('Insert Amount')); ?>">
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\veroo\resources\views/internal-money-transfer/bank-to-bank-form.blade.php ENDPATH**/ ?>