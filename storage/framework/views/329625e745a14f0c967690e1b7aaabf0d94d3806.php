...
<?php $component->withAttributes([]); ?>
	...
	if(isset($items_totals[$item]) && $items_totals[$item] != 0){
        ...
        <td class="text-center">
            ...
            <span><b class="color-<?php echo e(getPercentageColor($percentage_per_value)); ?>"> <?php echo e(number_format($percentage_per_value, 1) . ' %  '); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/client_view/reports/sales_gathering_analysis/two_dimensional_breakdown/bundling_report.blade.php ENDPATH**/ ?>