                        ...
                        <h3 class="kt-portlet__head-title head-title text-primary">
						  ...
						  <div class=" flex-1 d-flex justify-content-end pt-3">
							<div class="col-md-3 mb-3">
								...
								<div class="kt-input-icon">
									<input value="0" type="text" disabled class="form-control cash-balance-js" data-type="<?php echo e(MoneyReceived::CASH_IN_SAFE); ?>" placeholder="<?php echo e(__('Account Balance')); ?>">
								</div>
							</div>
