...
<?php endif; ?> 
                    ...
                    <div class="form-group row" style="flex:1;">
                        <div class="col-md-12 mt-3" data-repeater-row=".leasing-revenue-stream-category">
                            ...
                            <form id="form-id" class="kt-form kt-form--label-right" method="POST" enctype="multipart/form-data" action="<?php echo e(isset($disabled) && $disabled ? '#' :  $storeRoute); ?>">
								...
								<?php endif; ?> 
                                <input type="hidden" name="id" value="<?php echo e(isset($department) ? $department->id : 0); ?>">
            ...
            <div class="form-group mb-0 d-flex" style="margin-right:auto;gap:20px;">
                <input class="form-control" name="name" value="<?php echo e(isset($department) ? $department->getName():''); ?>" placeholder="">
            </div>
        </div>
		<div class="col-md-2">
                ...
                <div class="kt-input-icon">
                    <div class="input-group date">
                        <select data-live-search="true" data-actions-box="true" name="expense_type" class="form-control select2-select ">
                            ...
                            <option <?php if( isset($department) && $department->getExpenseTypeId() == $id  ): ?> selected <?php endif; ?> value="<?php echo e($id); ?>"><?php echo e($title); ?></option>
                                ...
                                <div id="positions" class="leasing-repeater-parent">
                                    <div class="form-group2  m-form__group2 row">
                                        <div data-repeater-list="positions" class="col-lg-12">
                                            ...
                                            <?php echo $__env->make('non_banking_services.manpower-structure._repeater' , [
                                            'tableId'=>'positions',
                                            'isRepeater'=>true ,
                                            'canAddNewItem'=>true ,
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/non_banking_services/manpower-structure/form.blade.php ENDPATH**/ ?>