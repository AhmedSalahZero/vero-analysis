...
<?php endif; ?> 
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="kt-input-icon">
                                        <div class="input-group date">
                                            <select data-current-selected="<?php echo e(isset($model) ? $model->getCashCoverDeductedFromAccountId(): 0); ?>" name="cash_cover_deducted_from_account_id" class="form-control js-account-number">
