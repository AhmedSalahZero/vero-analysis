<a data-toggle="modal" data-target="#apply-rate-for-<?php echo e($odAgainstAssignmentOfContract->id); ?>" type="button" class="btn  btn-secondary btn-outline-hover-success   btn-icon" title="<?php echo e(__('Update Interest Rate	')); ?>" href="#"><i class=" fa fa-percentage"></i></a>
                                        <div class="modal fade" id="apply-rate-for-<?php echo e($odAgainstAssignmentOfContract->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <form action="<?php echo e(route('overdraft-against-assignment-of-contract-apply.rates',['company'=>$company->id,'financialInstitution'=>$financialInstitution->id,'odAgainstAssignmentOfContract'=>$odAgainstAssignmentOfContract->id ])); ?>" method="post">
                                                        <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row mb-3 closest-parent">
                                                                ...
                                                                <?php echo $__env->make('reports.overdraft-against-assignment-of-contract.rates-form' , [
...
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/reports/overdraft-against-assignment-of-contract/apply-rate.blade.php ENDPATH**/ ?>