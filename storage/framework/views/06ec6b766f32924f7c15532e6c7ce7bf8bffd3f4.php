...
<form class="kt-form kt-form--label-right" id="create-form" method="POST" action="<?php echo e(route('calculate.fixed.at.end.and.beginning',['company' => $company->id])); ?>">
                    ...
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            ...
                            <select name="nature_type" id="nature_type" class="form-control">
                                <?php $__currentLoopData = ['fixed_at_end'=>__('Fixed At End') ,'fixed_at_beginning'=>__('Fixed At Beginning')]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $natureType => $natureTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<table class='table table-striped table-bordered table-hover table-checkable'>
	<thead>
		   <th class="text-center font-weight-bold"><?php echo e(__("Payment No.")); ?></th>
                            ...
                            <th class="text-center font-weight-bold"><?php echo e(__("Principle Amount")); ?></th>
	...
	?>
		...
		<tr>
			...
			<td class="text-center"><?php echo e(number_format($fixedAtEndResult['beginning'][$date] ?? 0)); ?></td>
			<td class="text-center"><?php echo e(number_format($fixedAtEndResult['schedulePayment'][$date] ?? 0)); ?></td>
			<td class="text-center"><?php echo e(number_format($fixedAtEndResult['interestAmount'][$date] ?? 0)); ?></td>
			<td class="text-center"><?php echo e(number_format($fixedAtEndResult['principleAmount'][$date] ?? 0)); ?></td>
			<td class="text-center"><?php echo e(number_format($fixedAtEndResult['endBalance'][$date] ?? 0)); ?></td>
		</tr>
		<?php
			$index++;
		?>
		...
		<tr class="custom-color-for-last-tr">
			...
			<th class="text-center"> <?php echo e(number_format($fixedAtEndResult['totals']['totalSchedulePayment'] ?? 0)); ?> </th>
			<th class="text-center"> <?php echo e(number_format($fixedAtEndResult['totals']['totalInterestAmount'] ?? 0)); ?> </th>
			<th class="text-center"> <?php echo e(number_format($fixedAtEndResult['totals']['totalPrincipleAmount'] ?? 0 )); ?> </th>
					<th>-</th>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/admin/loan2/at-end-and-beginning.blade.php ENDPATH**/ ?>