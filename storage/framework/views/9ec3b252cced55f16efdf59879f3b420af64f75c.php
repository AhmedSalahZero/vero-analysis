...
<?php $component = $__env->getContainer()->make(App\View\Components\Table::class, ['href' => $company ? route('user.create', [$company->id]) : route('user.create') ,'tableTitle' => __('Users Table')]); ?>
    ...
    <tr class="text-center">
        ...
        <td class="kt-datatable__cell--left kt-datatable__cell " data-field="Actions" data-autohide-disabled="false">
            <span style="overflow: visible; position: relative; width: 110px;">
                ...
                <a type="button" class="btn btn-secondary btn-outline-hover-brand btn-icon" title="Edit" href="<?php echo e(route('user.edit', [$item,$company->id])); ?>"><i class="fa fa-pen-alt"></i></a>
                <a class="btn btn-secondary btn-outline-hover-danger btn-icon remove-item-class remove-user-class" data-id="<?php echo e($item->id); ?>" title="Delete"><i class="fa fa-trash-alt"></i>
                </a>

                <a type="button" class="btn btn-secondary btn-outline-hover-brand btn-icon" title="Edit" href="<?php echo e(route('user.permissions.edit',[$item->id , $company->id])); ?>"><i class="fa fa-eye"></i></a>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/super_admin_view/users/index.blade.php ENDPATH**/ ?>