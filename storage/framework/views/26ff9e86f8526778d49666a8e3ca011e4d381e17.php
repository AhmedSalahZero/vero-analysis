...
<div id="kt_header" class="kt-header  kt-header--fixed fh-fixedHeader" data-ktheader-minimize="on">
    ...
    <div class="kt-container ">
        ...
        <?php else: ?>
        <?php echo $__env->make('layouts.old-topbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <!-- end: Header Menu -->
        ...
        <div class="kt-header__topbar kt-grid__item">
            ...
            <!--begin: Notifications -->
			<?php if(isset($company) && count($company->notifications)): ?>
            <div class="kt-header__topbar kt-grid__item ">
                        ...
                        <form>
                            ...
                            <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url(<?php echo e(asset('assets/media/misc/bg-1.jpg')); ?>)">
                                <h3 class="kt-head__title">
                                    ...
                                    &nbsp;
                                    <span class="btn btn-success btn-sm btn-bold btn-font-md"><?php echo e($company->unreadNotifications->count() . ' '.__(' new')); ?></span>
                                </h3>
                                <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-success kt-notification-item-padding-x" role="tablist">
								<?php
									$notificationTypeIndex = 0 ;
								?>
									<?php $__currentLoopData = $notificationTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notificationTypeId => $notificationTypeTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="nav-item">
                                        <a class="nav-link active show" data-toggle="tab" href="#topbar_<?php echo e(convertStringToClass($notificationTypeId)); ?>" role="tab" aria-selected="true"><?php echo e(__('Customer')); ?></a>
                                    </li>
                            ...
                            <div class="tab-content">
								...
								?>
										<?php $__currentLoopData = $notificationTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notificationTypeId => $notificationTypeTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="tab-pane <?php if($notificationTypeIndex == 0): ?> active show <?php endif; ?> " id="topbar_<?php echo e(convertStringToClass($notificationTypeId)); ?>" role="tabpanel">
                                    <div class="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll overflow-auto" data-scroll="true" data-height="300" data-mobile-height="200">
                                        <?php $__currentLoopData = $company->notifications->where('data.tap_type',$notificationTypeId); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="#" class="kt-notification__item <?php if($notification->read()): ?> kt-notification__item--read <?php endif; ?>">
                                            <div class="kt-notification__item-icon">
                                                <i class="flaticon2-favourite kt-font-danger"></i>
                                            </div>
                                            <div class="kt-notification__item-details">
                                                <div class="kt-notification__item-title">
                                                    <?php echo e($notification->data['message_'.app()->getLocale()]); ?>
...
<?php /**PATH C:\laragon\www\veroo\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>