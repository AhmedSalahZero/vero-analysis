                            ...
                            <div class="kt-portlet__body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-2">
                                        ...
                                        <div class="kt-input-icon">
                                            <div class="input-group">
                                                <input type="text" class="form-control only-greater-than-or-equal-zero-allowed trigger-change-repeater" value="<?php echo e(number_format(isset($model) ? $model->getBalanceAmount() : old('balance_amount',0))); ?>">
                                    ...
                                    <div class="col-2">
                                        ...
                                        <div class="kt-input-icon">
                                            <div class="input-group">
                                                <input type="text" class="form-control only-greater-than-or-equal-zero-allowed trigger-change-repeater" value="<?php echo e(number_format(isset($model) ? $model->getExchangeRate() : old('exchange_rate',0))); ?>">
