...
<?php endif; ?> 
  		...
  		<?php $__currentLoopData = $model->expenses->sortBy('date'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
             <div class="modal fade inner-modal-class" id="edit-expense-<?php echo e($expense->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
             ...
             <div class="modal fade inner-modal-class" id="delete-lc-issuance-expense<?php echo e($expense->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
 ...
 <?php echo $__env->make('reports.LetterOfCreditIssuance.cancel-issuance-modal'
 // ,['disabled'=>false]
