                 ...
                 <div class="modal-body">
                     <div class="row mb-3">
                         ...
                         <div class="col-md-3 mb-4">
                             ...
                             <div class="kt-input-icon">
                                 <input disabled value="<?php echo e(number_format($model->getLcAmount() )); ?>" type="text" class="form-control text-center">
                             </div>
                         </div>
     ...
     <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
         <div class="modal-content">
             <form action="<?php echo e(route('back.to.running.letter.of.credit.issuance',['company'=>$company->id,'letterOfCreditIssuance'=>$model->id,'source'=>$model->getSource() ])); ?>" method="post">
                 <?php echo csrf_field(); ?>
                 <div class="modal-header">
                     <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(__('Do You Want Cancel LC Payment ?')); ?></h5>
                     <button type="button" class="close" aria-label="Close">
                         <span aria-hidden="true">&times;</span>
                     </button>
                 </div>
