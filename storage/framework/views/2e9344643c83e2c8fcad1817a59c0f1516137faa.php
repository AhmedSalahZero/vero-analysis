<div class="row " id="contract-row-id">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select data-current-selected="<?php echo e(isset($model) && $model->downPayment ? $model->downPayment->getContractId():0); ?>" name="contract_id" id="contract-id" class="form-control ajax-get-purchases-orders-for-contract">
            </select>
        </div>
    </div>
	<div class="col-md-12">
...
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/reports/moneyPayments/unapplied-contract.blade.php ENDPATH**/ ?>