...
<?php $component->withAttributes([]); ?>
        ...
        <tr class="table-active text-center">
            <th class="text-center absorbing-column"><?php echo e(__('Business Sectors')); ?></th>
        ...
        <tr class="row<?php echo e($id); ?>  text-center" style="display: none">
            ...
            <td class="text-center">
                ...
                <span class="active-text-color color-<?php echo e(getPercentageColor($channel_section['Growth Rate %'][$date]??0)); ?>"><b> <?php echo e(' [ '.number_format(($channel_section['Growth Rate %'][$date]??0), 1) . ' %  ]'); ?></b></span>
            </td>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/client_view/reports/sales_gathering_analysis/businessSectors_analysis_report.blade.php ENDPATH**/ ?>