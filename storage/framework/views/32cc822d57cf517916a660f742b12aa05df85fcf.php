...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('second.allocations', $company)); ?>" method="POST">
        <?php echo csrf_field(); ?>
                            ...
                            <div class="kt-portlet__body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <label><?php echo e(__('Select Second Allocation Base')); ?> <span
                                        ...
                                        <div class="kt-input-icon">
                                            <div class="input-group date validated">
                                                <select name="allocation_base" class="form-control" id="allocation_base">
                                                    ...
                                                    <?php if($first_allocations_setting->allocation_base !=='branch' ): ?>
                                                        <option value="branch"
                                                            <?php echo e(@$allocations_setting['allocation_base'] !== 'branch' ?: 'selected'); ?>>
                                                            <?php echo e(__('Branches')); ?></option>
                                                    <?php endif; ?>
                                                    <?php if($first_allocations_setting->allocation_base !=='business_sector' ): ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <?php if($first_allocations_setting->allocation_base !=='sales_channel' ): ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <?php if($first_allocations_setting->allocation_base !== 'zone' ): ?>
                                                        <option value="zone"
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/client_view/forecast/second_allocations.blade.php ENDPATH**/ ?>