                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="kt-input-icon">
                                            <div class="input-group date">
                                                <input required type="text" name="deposit_date" value="<?php echo e(formatDateForDatePicker(now()->format('Y-m-d'))); ?>" max-date="<?php echo e(formatDateForDatePicker(now()->format('Y-m-d'))); ?>" class="form-control" readonly placeholder="Select date" id="kt_datepicker_max_date_is_today" />
...
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/components/export-money.blade.php ENDPATH**/ ?>