...
<?php $__env->startSection('sub-header'); ?>
    <?php echo e(__('Zone Sales Analysis')); ?>
...
<div class="row">
    <div class="col-md-12">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="POST" action=<?php echo e(route('zone.sales.analysis.result',$company)); ?>   enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">
                    <div class="form-group row">
                        <div class="col-md-4">
                            <label><?php echo e(__('Select Zones ( Multi Selection )')); ?> </label>
                            <div class="kt-input-icon">
                                <div class="input-group date">
                                    <select data-max-options="<?php echo e(maxOptionsForOneSelector()); ?>" data-live-search="true" data-actions-box="true" name="zones[]"   class="form-control  select2-select form-select kt-bootstrap-select kt_bootstrap_select" required  multiple>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/client_view/reports/sales_gathering_analysis/zone_sales_form.blade.php ENDPATH**/ ?>