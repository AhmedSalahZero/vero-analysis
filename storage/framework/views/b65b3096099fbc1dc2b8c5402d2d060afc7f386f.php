...
<?php endif; ?> 
                         ...
                         <?php $__env->slot('trs'); ?> 
                            <?php
                            $rows = isset($model) ? $model->leasingCategories : [-1] ;
                            ?>
                            ...
                            <?php
                            if( !($subModel instanceof LeasingCategory) ){
                            unset($subModel);
                            }
                            ?>
...
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/non_banking_services/leasing-categories/_repeater.blade.php ENDPATH**/ ?>