...
<div class="kt-portlet__head-toolbar" style="flex:1 !important;">
    <div class="kt-portlet__head-wrapper">
        <div class="kt-portlet__head-actions">
            ...
            <?php if($hasSearch): ?>
            <a data-type="multi" data-toggle="modal" data-target="#search-money-modal-<?php echo e($moneyReceivedType); ?>" id="js-search-money-received" href="#" title="<?php echo e(__('Search Settlements')); ?>" class="btn  active-style btn-icon-sm  ">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?php echo e(route('view.settlement.by.unapplied.amounts',['company'=>$company->id,'partnerId'=>$partnerId,'modelType'=>$modelType])); ?>" class="row ">
                                ...
                                <div class="form-group col-2">
                                    <label for="search-from " class="label"><?php echo e(__('From')); ?> <span class="data-type-span"><?php echo e(__('[ Settlement Date ]')); ?></span> </label>
                                    <input name="from" type="date" value="<?php echo e(request('from')); ?>" class="form-control">
                                </div>

                                <div class="form-group col-2">
                                    <label for="search-to " class="label"><?php echo e(__('To')); ?> <span class="data-type-span"><?php echo e(__('[ Settlement Date ]')); ?></span> </label>
...
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/components/search-unapplied-amounts.blade.php ENDPATH**/ ?>