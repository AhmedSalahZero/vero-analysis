...
<?php echo e(__('Certificates Of Deposit Form')); ?>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.sectionTitle','data' => ['title' => __((isset($model) ? 'Edit' : 'Add') . ' Certificates Of Deposit')]]); ?>
<?php $component->withName('sectionTitle'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__((isset($model) ? 'Edit' : 'Add') . ' Certificates Of Deposit'))]); ?> <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
...
<?php endif; ?> 
                                    ...
                                    <div class="col-md-2">
                                        <label><?php echo e(__('Add Maturity Amount To Account')); ?> <span class="required">*</span></label>
                                        <div class="input-group">
...
<?php endif; ?> 
            ...
            <script>
				...
				$(document).on('change','.recalculate-interest-amount',function(e){
					...
					console.log(diffBetweenEndDateAndStartDate,amount,intrestRate)
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\veroo\resources\views/reports/certificates-of-deposit/form.blade.php ENDPATH**/ ?>