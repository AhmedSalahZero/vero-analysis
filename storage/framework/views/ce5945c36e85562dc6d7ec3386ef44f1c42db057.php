                                ...
                                <div class="kt-portlet__body kt-portlet__body--fluid">
                                    <div class="kt-widget12">
                                        <div class="kt-widget12__chart">
                                            <!-- HTML -->
                                            <h4><?php echo e(str_replace('_', ' ', $name_of_zone) . ($name_of_zone ==  "Zone_Sales_Percentages" ? ' Against Total Sales' : ' Sales Trend Analysis Chart')); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Table::class, ['tableTitle' => __('Zone Sales Trend Analysis Report'),'tableClass' => 'kt_table_with_no_pagination_no_search']); ?>
...
<?php $component->withAttributes([]); ?>
                        <?php $__env->slot('table_header'); ?>
                            <tr class="table-active">
                                ...
                                <?php $__currentLoopData = $total_zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php $__env->slot('table_body'); ?>
                            <?php $__currentLoopData = $final_report_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone_name => $zoone_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="group-color text-lg-left  ">
                                    <td colspan="<?php echo e(count($total_zones) + 1); ?>"><b
                            ...
                            <tr>
                                ...
                                <?php $chart_data = []; ?>
                                <?php $__currentLoopData = $total_zones_growth_rates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    $chart_data[] = [
                                        'date' => date('d-M-Y', strtotime($date)),
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginale53a9d2e6d6c51019138cc2fcd3ba8ac893391c6 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Table::class, ['tableTitle' => __('Zone Sales Percentage (%) Against Total Sales'),'tableClass' => 'kt_table_with_no_pagination_no_search']); ?>
<?php $component->withName('table'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
                        ...
                        <?php $__env->slot('table_body'); ?>
                            ...
                            ?>
                            <input type="hidden" id="Zone_Sales_Percentages_data" data-total="<?php echo e(json_encode($return)); ?>">
...
<?php endif; ?>
                                      ...
                                      <?php echo $__env->make('seasonality_table' , ['total_branches'=>$total_zones , 'totalArrys'=>[]], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/client_view/reports/sales_gathering_analysis/zone_sales_report.blade.php ENDPATH**/ ?>