...
<div class="table-custom-container position-relative  ">
    ...
    <div style="padding-top:20px">
        <a href="<?php echo e(route('revenue-business.create',['company'=>$company->id])); ?>" class="btn btn-bold border-green mb-3 text-black flex-1 flex-grow-0 btn-border-radius mr-auto">
...
<?php $component->withAttributes([]); ?>
        ...
        <tr class="group-color main-row-tr" data-model-id="<?php echo e($mainId); ?>" data-model-name="RevenueBusinessLine">
            ...
            <td class=" max-w-80 editable font-weight-bold" contenteditable="true" title="<?php echo e(__('Click To Edit The Name')); ?>">
              <h5> <?php echo e($mainItemArr['data']['name']); ?></h5>
            </td>
            <td>
        ...
        <tr data-order="<?php echo e($order); ?>" class="row2<?php echo e($id); ?>   bg-last-row" style="display: none">
            <td>
				<div class="pl-5"><?php echo e(__('Item Name')); ?></div>
			</td>
            <td title="<?php echo e(__('Click To Edit The Name')); ?>" class="text-left text-capitalize bg-active-style editable" contenteditable="true" data-db-column-name="name" data-is-relation="0" data-model-id="<?php echo e($thirdSubId); ?>" data-model-name="ServiceItem">
                <div class="pl-4"><?php echo e($subArr['data']['name']); ?></div>
            </td>
            <td class="text-left ">
                <b class="ml-3">
                    <span style="overflow: visible; position: relative; width: 110px;">
