...
<div class="row">
    <div class="col-md-12">
        ...
        <form method="post" action="<?php echo e(route('store.down.payment.settlement',['company'=>$company->id,'moneyReceived'=>$moneyReceived->id,'partnerId'=>$partnerId])); ?>" class="kt-form kt-form--label-right">
							
		
            <input id="js-in-edit-mode" type="hidden" name="in_edit_mode" value="<?php echo e(isset($moneyReceived) ? 1 : 0); ?>">
            <input id="js-money-received-id" type="hidden" name="money_received_id" value="<?php echo e(isset($moneyReceived) ? $moneyReceived->id : 0); ?>">
                        ...
                        <div class="col-md-5">
						 ...
						 <div class="col-md-2">
							...
							<div class="form-group">
							 <input data-max-cheque-value="0" disabled type="text" value="<?php echo e($moneyReceived->getReceivedAmount()); ?>" name="received_amount" class="form-control only-greater-than-or-equal-zero-allowed   main-amount-class recalculate-amount-class" placeholder="<?php echo e(__('Received Amount')); ?>">
                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date">
                                    <select disabled name="currency" class="form-control current-currency ajax-get-invoice-numbers">
										...
										<?php
								$selected = isset($moneyReceived) ?  $moneyReceived->getCurrency()  == $currencyId  :  $currentName == $company->getMainFunctionalCurrency() ;
			...
			<div class="form-group row align-items-end">
				...
				<div class="col-md-2 width-12">
					...
					<div class="kt-input-icon">
						<input value="<?php echo e($moneyReceived->getSettlementsForInvoiceNumberAmount($invoice->getInvoiceNumber(),$partnerName)); ?>" name="settlements[<?php echo e($index); ?>][settlement_amount]" placeholder="<?php echo e(__("Settlement Amount")); ?>" type="text" class="form-control  only-greater-than-or-equal-zero-allowed settlement-amount-class">
					</div>
				</div>
				<div class="col-md-2 width-12">
					<label> <?php echo e(__('Withhold Amount')); ?> <span class="text-danger ">*</span> </label>
					<div class="kt-input-icon">
						<input value="<?php echo e($moneyReceived->getWithholdForInvoiceNumberAmount($invoice->getInvoiceNumber(),$partnerName)); ?>" name="settlements[<?php echo e($index); ?>][withhold_amount]" placeholder="<?php echo e(__('Withhold Amount')); ?>" type="text" class="form-control  only-greater-than-or-equal-zero-allowed ">
					</div>
				</div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/contracts-money-received-down-payment/settlement_form.blade.php ENDPATH**/ ?>