    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-toolbar justify-content-between flex-grow-1">
            <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(!Request('active') || Request('active') == MediumTermLoan::RUNNING ?'active':''); ?>" data-toggle="tab" href="#<?php echo e(MediumTermLoan::RUNNING); ?>" role="tab">
                        <i class="fa fa-money-check-alt"></i> <?php echo e(__('Medium Term Loan Table')); ?>
            ...
            <div class="flex-tabs">
                <a href="<?php echo e(route('loans.create',['company'=>$company->id,'financialInstitution'=>$financialInstitution->id,MediumTermLoan::RUNNING])); ?>" class="btn  active-style btn-icon-sm align-self-center">
