...
<div class="kt-portlet__head-toolbar">
    <div class="kt-portlet__head-wrapper">
        <div class="kt-portlet__head-actions">
            ...
            <?php if($hasSearch): ?>
            <a data-type="multi" data-toggle="modal" data-target="#search-modal-<?php echo e($type); ?>" id="js-search-money-received" href="#" title="<?php echo e(__('Search Letter Of Guarante Issuance')); ?>" class="btn  active-style btn-icon-sm  ">
...
<?php /**PATH C:\laragon\www\veroo\resources\views/components/export-letter-of-guarantee-issuance.blade.php ENDPATH**/ ?>