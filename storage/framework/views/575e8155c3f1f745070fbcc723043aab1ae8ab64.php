                ...
                <div class="col-md-10">
                    ...
                    <div class="kt-input-icon">
                        <div class="input-group date">
                            <input type="date" name="date" required value="<?php echo e($date); ?>" max="<?php echo e(date('Y-m-d')); ?>" class="form-control" placeholder="Select date" />
                        </div>
                    </div>
                </div>
...
<?php $component->withAttributes([]); ?>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><button type="button" class="btn btn-bold btn-label-brand btn-sm" data-toggle="modal" data-target="#kt_modal_<?php echo e(convertStringToClass($staticName)); ?>">
                            ...
                            <?php if($countVals > 0): ?>
                            <div class="modal fade" id="kt_modal_<?php echo e(convertStringToClass($staticName)); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
...
<?php $component->withAttributes([]); ?>
                    ...
                    <tr>
                        <td class="text-left"><?php echo e($customer->customer_name); ?></td>
...
<tr>
    ...
    <td class="text-center"><?php echo e($totalSales ? number_format(($totalSaleForCustomerType / $totalSales)*100 , 1 ) . ' %' : 0); ?></td>
    <?php if($countVals > 0): ?>
    <td class="text-center"><button type="button" class="btn btn-bold btn-label-brand btn-sm" data-toggle="modal" data-target="#kt_modal_<?php echo e(convertStringToClass($name)); ?>"> <?php echo e(__($name.' - Customers')); ?></button></td>
    <?php else: ?>
    <td class="text-center"><b><?php echo e(__('No Customers')); ?></b></td>
    <?php endif; ?>
</tr>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/client_view/home_dashboard/dashboard_customers.blade.php ENDPATH**/ ?>