                            ...
                            <table class="table kt_table_with_no_pagination_no_collapse table-striped- table-bordered table-hover table-checkable position-relative table-with-two-subrows main-table-class dataTable no-footer">
                                <thead>
                                    ...
                                    <tr class="header-tr ">
                                        ...
                                        <th class="view-table-th   bg-lighter  header-th  align-middle text-center">
                                            <?php echo __('Downpayment Amount <br> Settlement'); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\veroo\resources\views/admin/reports/invoice-report.blade.php ENDPATH**/ ?>