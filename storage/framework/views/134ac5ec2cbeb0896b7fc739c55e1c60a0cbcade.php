...
<?php $component->withAttributes([]); ?>
                            ...
                            <tr class="table-active text-center">
                                <th class="text-center "><?php echo e(__('Month')); ?></th>
                                <th class="text-center "><?php echo e(__('Sales Value')); ?></th>
                                <th class="text-center "><?php echo e(__('Month %')); ?></th>
                                <td class="text-center "><?php echo e(__('YoY GR%')); ?></td>
                            </tr>
                            <?php $__env->endSlot(); ?>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="bg-antiquewhite"><?php echo e(number_format(($data_per_year['Month Sales %'][$date]??0),2) . ' %'); ?></td>
                                <?php
                                ...
                                if($yoyGR < 0 ) { $yoyGRColor='red !important' ; } elseif($yoyGR> 0){
                                    ...
                                    ?>
                                    <td style="color:<?php echo e($yoyGRColor); ?>"><?php echo e(number_format(($yoyGR),2) . ' %'); ?></td>
                            </tr>
...
<?php $component->withAttributes([]); ?>
                            <?php $__env->slot('table_header'); ?>
                            <tr class="table-active text-center">
                                <th class="text-center"><?php echo e(__('Quarter')); ?></th>
                                <th class="text-center"><?php echo e(__('Quarter Sales %')); ?></th>
                            </tr>
                            <?php $__env->endSlot(); ?>
                            <?php $__env->slot('table_body'); ?>
                            <?php $sum_totals = array_sum($total_full_data); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/client_view/reports/sales_gathering_analysis/sales_report/comparing_sales_report.blade.php ENDPATH**/ ?>