<div data-card-id="<?php echo e($cardId); ?>" class="kt-portlet parent-card ">
 ...
 <?php
                ...
                <form id="form-id" class="kt-form kt-form--label-right" method="POST" enctype="multipart/form-data" action="<?php echo e($storeDepartmentPositionsRoute); ?>">
                    <?php echo $__env->make('financial_planning.manpower._input-hidden', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/financial_planning/manpower/_department_card.blade.php ENDPATH**/ ?>