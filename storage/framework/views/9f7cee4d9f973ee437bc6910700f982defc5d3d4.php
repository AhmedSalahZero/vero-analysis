...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('main-form-title'),'class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('')]); ?><?php echo e(__('Cash Expense Statement ['  ) . ' ' . __($currency) . ' ]'); ?> [<?php echo e($expenseCategory); ?>] [<?php echo e($expenseCategoryName); ?>] <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
                            ...
                            <table class="table kt_table_with_no_pagination_no_collapse table-striped- table-bordered table-hover table-checkable position-relative table-with-two-subrows main-table-class dataTable no-footer">
                                <thead>
                                    ...
                                    <tr class="header-tr ">
                                        ...
                                        <th class="view-table-th max-w-currency    header-th  align-middle text-center">
										   ...
										   <th class="view-table-th max-w-currency    header-th  align-middle text-center">
                                            <?php echo e(__('Accumulated Amount')); ?>
                                ...
                                <tbody>
                                    ...
                                    <tr class=" parent-tr reset-table-width text-nowrap  cursor-pointer sub-text-bg text-capitalize is-close   ">
                                        ...
                                        <td class="sub-text-bg  text-center "><?php echo e(\Carbon\Carbon::make($modelAsStdClass->payment_date)->format('d-m-Y')); ?></td>
                                        <td class="sub-text-bg text-center max-w-invoice-number"><?php echo e(number_format($modelAsStdClass->paid_amount)); ?></td>
                                        <td class="sub-text-bg text-center max-w-invoice-number"><?php echo e(number_format($accumulatedAmount)); ?></td>
                                        <td class="sub-text-bg text-center "><?php echo e(str_to_upper($modelAsStdClass->type)); ?></td>
									    <td class="sub-text-bg <?php echo e(isArabic($modelAsStdClass->user_comment) ? 'text-right' : 'text-left'); ?> max-w-amount"><?php echo e($modelAsStdClass->user_comment); ?></td>
                                    </tr>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/cash_expense_statement_result.blade.php ENDPATH**/ ?>