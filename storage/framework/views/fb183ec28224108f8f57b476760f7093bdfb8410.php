                ...
                <div class="row leasing-revenue-stream-category">
                    ...
                    <div class="form-group row" style="flex:1;">
                        <div class="col-md-12 mt-3" data-repeater-row=".leasing-revenue-stream-category">
                            ...
                            <form id="main-form-id" class="kt-form kt-form--label-right" method="POST" enctype="multipart/form-data" action="<?php echo e(isset($disabled) && $disabled ? '#' :  $storeRoute); ?>">
                                ...
                                <div id="microfinanceProducts" class="leasing-repeater-parent">
                                    <div class="form-group2  m-form__group2 row">
                                        <div data-repeater-list="microfinanceProducts" class="col-lg-12">

                                            <?php echo $__env->make('non_banking_services.microfinance-products._repeater' , [

                                            'tableId'=>'microfinanceProducts',
                                            'isRepeater'=>true ,
                                            'canAddNewItem'=>true ,
                                            'model'=>$model
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/non_banking_services/microfinance-products/form.blade.php ENDPATH**/ ?>