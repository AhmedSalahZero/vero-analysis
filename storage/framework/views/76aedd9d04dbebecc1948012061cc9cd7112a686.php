...
<div class="row">
    <div class="col-md-12">
        ...
        ?>
        <?php echo $__env->make('financial_planning.manpower._department_card', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <?php echo $__env->make('financial_planning.manpower._department_card',[
        'departments'=>[],
        'department'=>null,
...
<?php endif; ?> 
 ...
 <div class="row btn-for-submit--js <?php echo e(isset($isHidden)&&$isHidden ? 'd-none':''); ?>">
                ...
                <div class="col-lg-6 kt-align-right">
                    <a href="<?php echo e(route('view.financial.planning.income.statement',['company'=>$company->id,'study'=>$study->id])); ?>"   class="btn active-style" >
						<?php echo e(__('Back To Income Statement')); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/financial_planning/manpower/form.blade.php ENDPATH**/ ?>