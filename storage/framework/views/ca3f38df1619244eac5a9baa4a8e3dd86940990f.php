        ...
        <form method="post" action="<?php echo e(route('store.down.payment.settlement',['company'=>$company->id,'downPaymentId'=>$downPayment->id,'partnerId'=>$partnerId,'modelType'=>$modelType])); ?>" class="kt-form kt-form--label-right">
			...
			<div class="form-group row align-items-end">
				...
				<div class="col-md-2 width-12">
					...
					<div class="kt-input-icon">
						<input value="<?php echo e($downPayment->getSettlementsForInvoiceNumberAmount($invoice->getInvoiceNumber(),$partnerName)); ?>" name="settlements[<?php echo e($index); ?>][settlement_amount]" placeholder="<?php echo e(__("Settlement Amount")); ?>" type="text" class="form-control  only-greater-than-or-equal-zero-allowed settlement-amount-class">
					</div>
				</div>
				<div class="col-md-2 width-12">
					<label> <?php echo e(__('Withhold Amount')); ?> <span class="text-danger ">*</span> </label>
					<div class="kt-input-icon">
						<input value="<?php echo e($downPayment->getWithholdForInvoiceNumberAmount($invoice->getInvoiceNumber(),$partnerName)); ?>" name="settlements[<?php echo e($index); ?>][withhold_amount]" placeholder="<?php echo e(__('Withhold Amount')); ?>" type="text" class="form-control  only-greater-than-or-equal-zero-allowed ">
					</div>
				</div>
