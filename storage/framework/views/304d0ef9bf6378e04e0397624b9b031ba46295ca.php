                        ...
                        <table class="table  table-striped- table-bordered table-hover table-checkable text-center kt_table_1">
                            <thead>
                                <tr class="table-standard-color">
                                    ...
                                    <th class="align-middle"><?php echo e(__('Customer Name')); ?></th>
                                    ...
                                    <th class="align-middle" class="bank-max-width"><?php echo e(__('Drawee Bank')); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($moneyReceived->getCustomerName()); ?></td>
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable text-center kt_table_1">
                            <thead>
                                <tr class="table-standard-color">
                                    ...
                                    <th class="align-middle"><?php echo __('Customer <br> Name'); ?></th>
                                    <th class="align-middle"><?php echo __('Cheque <br> Number'); ?></th>
                                    <th class="align-middle"><?php echo __('Cheque <br> Amount'); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
								   <td><?php echo e($money->getMoneyTypeFormatted()); ?></td>
                                    ...
                                    <td><?php echo e($money->getIncomingTransferReceivingBankName()); ?></td>
                                    ...
                                    <td><?php echo e($money->getIncomingTransferAccountTypeName()); ?></td>
                            ...
                            <tbody>
                                ...
                                <tr>
								   <td><?php echo e($money->getMoneyTypeFormatted()); ?></td>
                                    <td><?php echo e($money->getCustomerName()); ?></td>
                                    <td class="text-nowrap"><?php echo e($money->getReceivingDateFormatted()); ?></td>
                                    <td><?php echo e($money->getCashInBankReceivingBankName()); ?></td>
                                    <td><?php echo e($money->getReceivedAmountFormatted()); ?></td>
                                    <td data-currency="<?php echo e($money->getCurrency()); ?>"> <?php echo e($money->getCurrencyFormatted()); ?></td>
                                    <td><?php echo e($money->getCashInBankAccountTypeName()); ?></td>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\veroo\resources\views/reports/moneyReceived/index.blade.php ENDPATH**/ ?>