                    ...
                    <?php $__currentLoopData = $section->subSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subSection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ||(false !== $found = array_search(\Str::singular($name),       $viewing_names) || $subSection->name['en'] == "Average Prices" )): ?>
                                ...
                                <li class="nav-item">
                                    ...
                                    <a class="nav-link <?php echo e($section_key == 0 ? 'active' : ''); ?>" data-toggle="tab" href="#kt_widget2_tab1_content_<?php echo e($subSection->id); ?>" role="tab">

                                        <i
                                        class="kt-menu__ver-arrow <?php echo e($subSection->icon); ?>"></i><span class="kt-menu__link-text">
                                            
                                            <?php echo e($subSection->name[lang()]); ?>
                                                    ...
                                                    <div class="kt-widget2__item kt-widget2__item--primary">
                                                        ...
                                                        <div class="kt-widget2__info">
                                                            <a href="<?php echo e(route(@$sub_section->route, $company)); ?>" class="kt-widget2__title">
                                                                <?php echo e($sub_section->name[lang()]); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/client_view/analysis_reports_lists.blade.php ENDPATH**/ ?>