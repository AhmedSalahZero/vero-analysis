...
<div class="row">
    <div class="col-md-12">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="POST" action="<?php echo e(route('result.collections.effectiveness.index',['company'=>$company->id  ])); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="kt-portlet" style="overflow-x:hidden">
                <div class="kt-portlet__body">
					...
					<div class="col-md-3 mb-4">
                            <label><?php echo e(__('Select Report Type')); ?>  </label>
                            <div class="kt-input-icon">
                                <div class="input-group date" >
                                    <select  data-live-search="true" data-actions-box="true" name="report_type" class="form-control  kt-bootstrap-select select2-select kt_bootstrap_select " >
                                        <option value="whole_interval"> <?php echo e(__('Whole Internal')); ?></option>
					 ...
					 <div class="col-md-3 mb-4">
                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date" >
                                    <input type="date" class="form-control" name="start_date" value="<?php echo e($defaultStartDate); ?>">
                                </div>
                            </div>
                        </div>
					 ...
					 <div class="col-md-3 mb-4">
                            <label><?php echo e(__('End Date')); ?></span> </label>
                            <div class="kt-input-icon">
                                <div class="input-group date" >
                                    <input type="date" class="form-control" name="end_date" value="<?php echo e($defaultEndDate); ?>">
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/admin/reports/collection-effectiveness-index/form.blade.php ENDPATH**/ ?>