...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('second.new.product.seasonality', $company)); ?>" method="POST">
        <?php echo csrf_field(); ?>
                ...
                <div class="kt-form__actions">
                    <div class="row">
                        ...
                        <div class="col-lg-6 kt-align-right">
                            <button type="submit" class="btn active-style"><?php echo e(__('Collection')); ?></button>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/client_view/forecast/second_new_product_seasonality.blade.php ENDPATH**/ ?>