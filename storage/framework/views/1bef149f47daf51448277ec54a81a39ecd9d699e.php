                        ...
                        <table class="table  table-striped- table-bordered table-hover table-checkable text-center kt_table_1">
                            <thead>
                                <tr class="table-standard-color">
                                    ...
                                    <th class="align-middle"><?php echo e(__('Status')); ?></th>
                                    <th class="align-middle"><?php echo e(__('Supplier Name')); ?></th>
                                    ...
                                    <th class="align-middle " class="bank-max-width"><?php echo e(__('Payment Bank')); ?></th>
                                    <th class="align-middle"><?php echo e(__('Account Type')); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="<?php if($moneyPayment->payableCheque->getStatus() == 'paid'): ?> text-success color-green <?php endif; ?> "><?php echo e($moneyPayment->payableCheque->getStatusFormatted()); ?></td>
                                    <td><?php echo e($moneyPayment->getMoneyTypeFormatted()); ?></td>
                                    <td><?php echo e($moneyPayment->getSupplierName()); ?></td>
                                    ...
                                    <td class="text-transform" data-currency="<?php echo e($moneyPayment->getCurrency()); ?>"><?php echo e($moneyPayment->getCurrencyFormatted()); ?></td>
                                    <td class="bank-max-width "><?php echo e($moneyPayment->payableCheque->getDeliveryBankName()); ?></td>
                                    <td class=""><?php echo e($moneyPayment->payableCheque->getAccountTypeName()); ?></td>
                                    ...
                                    <td class="font-weight-bold" style="color:<?php echo e($dueStatus['color']); ?>!important">
                            ...
                            <tbody>
								...
								<td>
								   ...
								   <td><?php echo e($money->getMoneyTypeFormatted()); ?></td>
                                    <td><?php echo e($money->getSupplierName()); ?></td>
                                    <td class="text-nowrap"><?php echo e($money->getDeliveryDateFormatted()); ?></td>
                                    <td><?php echo e($money->getOutgoingTransferDeliveryBankName()); ?></td>
                                    ...
                                    <td><?php echo e($money->getOutgoingTransferAccountTypeName()); ?></td>
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable text-center kt_table_1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($moneyPayment->getPaidAmountFormatted()); ?></td>
                                    <td data-currency="<?php echo e($moneyPayment->getCurrency()); ?>"><?php echo e($moneyPayment->getCurrencyFormatted()); ?></td>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\veroo\resources\views/reports/moneyPayments/index.blade.php ENDPATH**/ ?>