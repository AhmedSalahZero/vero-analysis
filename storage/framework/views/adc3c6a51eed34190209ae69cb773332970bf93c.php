                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="kt-input-icon">
                                            <div class="input-group date">
                                                <input required type="text" name="actual_payment_date" value="<?php echo e(formatDateForDatePicker(isset($dueDate) ? $dueDate : now()->format('Y-m-d') )); ?>" class="form-control" readonly placeholder="Select date" id="kt_datepicker_2" />
...
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/components/export-money-payment.blade.php ENDPATH**/ ?>