...
'hasBatchCollection','hasSearch','currentType','searchFields'
,
    ...
    <div class="kt-portlet__head-wrapper">
        <div class="kt-portlet__head-actions">
            &nbsp;
				...
				<?php if($hasSearch): ?>
            <a  data-type="multi" data-toggle="modal" data-target="#search-study-<?php echo e($currentType); ?>" id="js-search-money-received" href="#" title="<?php echo e(__('Search Money Received')); ?>" class="btn  active-style btn-icon-sm  ">
                <i class="fas fa-search"></i>
                <?php echo e(__('Search')); ?>

            </a>
	
			<div class="modal fade" id="search-study-<?php echo e($currentType); ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo csrf_field(); ?>
                            <form action="<?php echo e(route('lc-settlement-internal-money-transfers.index',['company'=>$company->id ])); ?>"  class="row ">
                            <input name="active" type="hidden" value="<?php echo e($currentType); ?>">
                                <div class="form-group col-4" >
                                    <label for="Select Field " class="label"><?php echo e(__('Field Name')); ?></label>
                                    <select id="js-search-modal-name-<?php echo e($currentType); ?>" data-type="<?php echo e($currentType); ?>" class="form-control js-search-modal" type="date" name="field" placeholder="<?php echo e(__('Delete From')); ?>">
                        ...
                        <div class="modal-footer">
                            <button type="submit" href="<?php echo e(route('view.study',['company'=>$company->id])); ?>" id="js-search-id" type="submit" id="" class="btn btn-primary"><?php echo e(__('Search')); ?></button>
                        </div>
...
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/components/export-study.blade.php ENDPATH**/ ?>