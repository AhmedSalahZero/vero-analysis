...
<div class="row">
    <div class="col-md-12">
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="POST" action=<?php echo e($name_of_selector_label == 'Sales Discount' ? route('Items.salesDiscount.analysis.result', $company) : route('Items.analysis.result', $company)); ?> enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                ...
                <div class="kt-portlet__body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date">
                                    <select <?php if( ($name_of_selector_label=='Sales Discount' ) ): ?> disabled <?php endif; ?> name="data_type" id="data_type" class="form-control">
					...
					<?php if(isset(get_defined_vars()['__data']['type']) && get_defined_vars()['__data']['type'] !='averagePrices'): ?>
					 <div class="col-md-4  first-interval">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date">
                                    <input type="date" value="<?php echo e(getEndYearBasedOnDataUploaded($company)['jan']); ?>" name="start_date" required class="form-control trigger-update-select-js" placeholder="Select date" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group row">
                        <div class="col-md-<?php echo e($column); ?>">
                            <label><?php echo e(__('Select Products Items')); ?> <?php echo $__env->make('max-option-span', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> </label>
                            <div class="kt-input-icon">
                                <div class="input-group date">
                    ...
                    <?php else: ?>
                    <div class="col-md-<?php echo e($column); ?>">
                        <label><?php echo e(__('Select '.$name_of_selector_label.' ')); ?> <span class="multi_selection"></span>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/client_view/reports/sales_gathering_analysis/skus_analysis_form.blade.php ENDPATH**/ ?>