...
<?php $component->withAttributes([]); ?>
    ...
    <tr class="table-active text-center">
        ...
        <?php for($i = 1 ; $i <= count($data) ; $i++): ?> <?php $__currentLoopData = ['Rank [ '.$i.' ] '.ucwords(str_replace(' _', ' ' , $type)) , 'Percentage %' , 'Value' , 'Percentage %' ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <th><?php echo e(__($item)); ?></th>
    ...
    <tr>
        ...
        <?php for($rankNumber = 1 ;$rankNumber <= count($data) ; $rankNumber++ ): ?> <?php $totalForBranch=countTotalForBranch($data[$branchName]) ?> <?php $allRanksTotals=countSumForAllRank($data , $rankNumber) ?> <td class="text-center">
...
<?php $component->withAttributes([]); ?>
    ...
    <tr>
        ...
        <td style="text-align: left !important"> <?php echo e(++$produtNumber); ?> - <?php echo e($productName); ?></td>
...
<tr class="table-active text-center">
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branchName => $statistics): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php for($rankNumber = 1 ;$rankNumber <= count($data) ; $rankNumber++ ): ?> <?php $allRanksTotals=countSumForAllRank($data , $rankNumber) ?> <td class="text-center">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/client_view/reports/sales_gathering_analysis/two_dimensional_breakdown/sales_ranking_report.blade.php ENDPATH**/ ?>