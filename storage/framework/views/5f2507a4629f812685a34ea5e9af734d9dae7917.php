                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-group">
                                                <select name="from_currency" id="from-currency-<?php echo e($existingCurrency); ?>" class="form-control js-change-currency">
                                                    ...
                                                    <option value="<?php echo e($currencyName); ?>" <?php if(isset($model) && $model->getFromCurrency() == $currencyName ): ?> selected <?php elseif($currencyName == $existingCurrency ): ?> selected <?php endif; ?> > <?php echo e($currencyValue); ?></option>
