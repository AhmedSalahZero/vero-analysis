                                ...
                                <div id="consumerfinanceProducts" class="leasing-repeater-parent">
                                    <div class="form-group2  m-form__group2 row">
                                        <div data-repeater-list="consumerfinanceProducts" class="col-lg-12">
                                            ...
                                            <?php echo $__env->make('non_banking_services.consumerfinance-products._repeater' , [
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/non_banking_services/consumerfinance-products/form.blade.php ENDPATH**/ ?>