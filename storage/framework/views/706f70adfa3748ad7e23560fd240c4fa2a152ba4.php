...
<?php echo e(__('LG By Bank Name Report')); ?>
...
<div class="row">
    <div class="col-md-12">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="get" action="<?php echo e(route('result.lg.by.bank.name.report',['company'=>$company->id ])); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="kt-portlet" style="overflow-x:hidden">
                <div class="kt-portlet__body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <label><?php echo e(__('Bank')); ?> <?php echo $__env->make('star', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></label>
                            <div class="kt-input-icon">
                                <div class="input-group date">

                                    <select data-live-search="true" data-actions-box="true" id="bank-id"  name="bank_id" class="form-control select2-select">
...
$(document).on('change','[js-get-bank]',function(e){
	...
	if(currencyName){
		$.ajax({
			url:"<?php echo e(route('get.bank.name.by.currency',['company'=>$company->id])); ?>",
			data:{
				currencyName
			},
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/lg_by_bank_name_form.blade.php ENDPATH**/ ?>