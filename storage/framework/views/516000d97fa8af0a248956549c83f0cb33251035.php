    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-toolbar justify-content-between flex-grow-1">
            <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(!Request('active') || Request('active') == 'overdraft-against-assignment-of-contract' ?'active':''); ?>" data-toggle="tab" href="#overdraft-against-assignment-of-contract" role="tab">
                        <i class="fa fa-money-check-alt"></i> <?php echo e(__('Overdraft Against Assignment Of Contract Table')); ?>
            ...
            <div class="flex-tabs">
                <a href="<?php echo e(route('create.overdraft.against.assignment.of.contract',['company'=>$company->id,'financialInstitution'=>$financialInstitution->id])); ?>" class="btn  active-style btn-icon-sm align-self-center">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <a 
																						 ...
																						 href="<?php echo e(route('apply.against.lending',['company'=>$company->id , 'financialInstitution'=>$financialInstitution->id,'lendingInformation'=>$lendingInformationAgainstAssignmentOfContract->id])); ?>"
																						 data-target="#apply-lending-information-<?php echo e($lendingInformationAgainstAssignmentOfContract->id); ?>" type="button" class="btn btn-secondary btn-outline-hover-primary btn-icon" type="button" class="btn btn-secondary btn-outline-hover-brand btn-icon" title="<?php echo e(__('Apply Against Lending')); ?>"><i class="fa fa-balance-scale"></i></a>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\veroo\resources\views/reports/overdraft-against-assignment-of-contract/index.blade.php ENDPATH**/ ?>