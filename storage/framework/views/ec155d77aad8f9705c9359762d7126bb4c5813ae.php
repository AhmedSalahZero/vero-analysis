    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="kt-form kt-form--label-right" method="POST"
                action= <?php if($name_of_selector_label == 'Sales Discount'): ?> <?php echo e(route('products.salesDiscount.analysis.result', $company)); ?>

                        <?php elseif($type == 'averagePricesProductItems'): ?> <?php echo e(route('averagePrices.result', $company)); ?>

                        <?php else: ?> <?php echo e(route('products.analysis.result', $company)); ?>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            <div class="col-md-<?php echo e($column); ?>">
                                <label><?php echo e(__('Select products ( Multi Selection )')); ?> </label>
                                <div class="kt-input-icon">
                                    <div class="input-group date">
                                        <select data-live-search="true" data-actions-box="true" name="productsData[]" required class="select2-select form-control kt-bootstrap-select kt_bootstrap_select"
                                            id="productsData" multiple>
                                ...
                                <div class="col-md-<?php echo e($column); ?>">
                                    ...
                                    <div class="kt-input-icon">
                                        <div class="input-group date" id="sales_channels">
                                            ...
                                            class="form-control select2-select kt-bootstrap-select kt_bootstrap_select" multiple>
...
<?php $__env->startSection('js'); ?>
  ...
  wto = setTimeout(()=> {
        ...
        function getSalesChannales(productsData,type_of_data) {
            $.ajax({
            type:'GET',
            data: {'main_data' : productsData , 'main_field' : 'product_or_service','field' : type_of_data} ,
        ...
        function getCategories(productsData,type_of_data) {
            $.ajax({
            type:'GET',
            data: {'main_data' : productsData, 'main_field' : 'sales_channel','field' : type_of_data} ,
            url: '<?php echo e(route('get.zones.data',$company)); ?>',
            dataType:'json',
            accepts:'application/json'
            }).done(function (data) {
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/client_view/reports/sales_gathering_analysis/products_analysis_form.blade.php ENDPATH**/ ?>