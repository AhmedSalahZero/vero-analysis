                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo csrf_field(); ?>
                            <form action="<?php echo e(route('view.time.of.deposit',['company'=>$company->id,'financialInstitution'=>$financialInstitution->id ])); ?>"  class="row ">
...
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/components/export-time-of-deposit.blade.php ENDPATH**/ ?>