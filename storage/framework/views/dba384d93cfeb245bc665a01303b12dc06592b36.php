...
<?php echo $__env->make('client_view.home_dashboard.main_navs-income-statement',['active'=>'interval_dashboard'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            <h3 class="kt-portlet__head-title head-title text-primary">
                <?php echo e(__('Income Statement Comparing')); ?>

            </h3>
        </div>
    </div>
    <div class="kt-portlet__body">
        <form action="<?php echo e(route('dashboard.intervalComparing.incomeStatement',['company'=>$company,'subItemType'=>Request()->segments()[4]])); ?>" method="POST">
            <?php echo csrf_field(); ?>
                ...
                <div class="col-md-8">
                    <div class="input-group date">
                        <select data-actions-box="true" data-live-search="true" data-max-options="0" name="types[]" required class="form-control select2-select form-select form-select-2 form-select-solid fw-bolder select-all" multiple>
                            ...
                            <option value="<?php echo e($id); ?>" <?php if(in_array($id , $selectedTypes ) || $selectAllOptions): ?> selected <?php endif; ?>> <?php echo e($name); ?> </option>
            ...
            <div class="form-group row ">
                ...
                <div class="col-md-4">
                    <label><b><?php echo e(__('Income Statements')); ?></b></label>
                </div>
                <div class="col-md-4">
                    <label><?php echo e(__('First Income Statement')); ?></label>

                    <select id="income_statement_first_id" data-live-search="true" data-max-options="2" name="financial_statement_able_first_interval" required class="form-control select2-select form-select form-select-2 form-select-solid fw-bolder" >
                        ...
                        <option value="<?php echo e($incomeSatatement->id); ?>" <?php if($firstIncomeStatement->id == $incomeSatatement->id ): ?> selected <?php endif; ?> > <?php echo e($incomeSatatement->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div class="col-md-4">
                    <label><?php echo e(__('Second Income Statement')); ?></label>
                    <select id="income_statement_second_id" data-live-search="true" data-max-options="2" name="financial_statement_able_second_interval" required class="form-control select2-select form-select form-select-2 form-select-solid fw-bolder" >
                        <?php $__currentLoopData = $incomeStatements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $incomeStatement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($incomeStatement->id); ?>" <?php if($secondIncomeStatement->id == $incomeStatement->id ): ?> selected <?php endif; ?> > <?php echo e($incomeStatement->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="form-group row ">
                <div class="col-md-4">
                    <label><b><?php echo e(__('Report Type')); ?></b></label>
                </div>


                <div class="col-md-4">
                    <label><?php echo e(__('First Report Type')); ?></label>
                    <select id="first-report-type" data-actions-box="false" data-live-search="true" data-max-options="1" name="first_report_type" required class="form-control select2-select form-select form-select-2 form-select-solid fw-bolder select-all">
                        <?php $__currentLoopData = getAllFinancialAbleTypes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $firstReportType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option  value="<?php echo e($firstReportType); ?>" <?php if($firstReportType==$selectedItems['first_report_type']): ?> selected <?php endif; ?>> <?php echo e(toupperfirst($firstReportType)); ?> </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				 ...
				 <div class="col-md-4">
                    <label><?php echo e(__('Second Report Type')); ?></label>
                    <select id="second-report-type" data-actions-box="false" data-live-search="true" data-max-options="1" name="second_report_type" required class="form-control select2-select form-select form-select-2 form-select-solid fw-bolder select-all">
                        <?php $__currentLoopData = getAllFinancialAbleTypes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $secondReportType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($secondReportType); ?>" <?php if($secondReportType==$selectedItems['second_report_type']): ?> selected <?php endif; ?>> <?php echo e(toupperfirst($secondReportType)); ?> </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="form-group row ">
                <div class="col-md-4">
                    <label><b><?php echo e(__('Start Date')); ?></b></label>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="kt-input-icon">
                        <div class="input-group date">
                            <input type="date" id="start_date_one_input_id" name="start_date_one" required value="<?php echo e($start_date_0); ?>" class="form-control" placeholder="Select date" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="kt-input-icon">
                        <div class="input-group date">
                            <input type="date" id="start_date_second_input_id" name="start_date_two" required value="<?php echo e($start_date_1); ?>" class="form-control" placeholder="Select date" />
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group row ">
                <div class="col-md-4">
                    <label><b><?php echo e(__('End Date')); ?></b></label>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="kt-input-icon">
                        <div class="input-group date">
                            <input id="end_date_one_input_id" type="date" name="end_date_one" required value="<?php echo e($end_date_0); ?>" class="form-control" placeholder="Select date" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="kt-input-icon">
                        <div class="input-group date">
                            <input id="end_date_second_input_id" type="date" name="end_date_two" required value="<?php echo e($end_date_1); ?>" class="form-control" placeholder="Select date" />
                        </div>
                    </div>
                </div>
                      ...
                      <table class="table table-striped- table-bordered table-hover table-checkable position-relative table-with-two-subrows main-table-class dataTable no-footer">
                        <thead>
                            <tr class="header-tr ">
                                ...
                                <?php $__currentLoopData = $intervals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $intervalName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								<?php if($index == 0): ?>
								<?php echo e($firstIncomeStatement->getName()); ?> <br>
								<?php echo e($selectedItems['first_report_type'] ?? ''); ?>

								<?php else: ?>
								<?php echo e($secondIncomeStatement->getName()); ?> <br>
								<?php echo e($selectedItems['second_report_type'] ?? ''); ?>

								<?php endif; ?> 
								 <br> (<?php echo e(getIntervalFromString($intervalName)); ?>)</th>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/client_view/home_dashboard/dashboard_intervalComparing_income_statements.blade.php ENDPATH**/ ?>