            ...
            <h3 class="kt-portlet__head-title head-title text-primary w-full">
                ...
                <div class="row mb-3">
                    <div class="col-md-2">
                        ...
                        <h3 class="font-weight-bold text-black form-label kt-subheader__title small-caps mr-5" style=""> <?php echo e(__('Dashboard Results')); ?></h3>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\veroo\resources\views/admin/dashboard/cash.blade.php ENDPATH**/ ?>