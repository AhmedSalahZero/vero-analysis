    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <form class="kt-form kt-form--label-right" method="POST"
                action="<?php echo e(route('table.fields.selection.save', [$company,$model, $view])); ?>"
                                            ...
                                            <label class="kt-option <?php if($status_disanbeled_fields): ?> not_allowed_curser <?php endif; ?>">
                                                <span class="kt-option__control ">
                                                    ...
                                                    <label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand
                                                        ...
                                                        <?php endif; ?>">
                                                        <input   type="checkbox" name="fields[]" value="<?php echo e($fieldName); ?>"
                                                            <?php if($fieldName != 'net_sales_value'): ?>
                                                            class="fields"
                                                            <?php endif; ?>
                                                            <?php if(((false !== $found = array_search($fieldName,$selected_fields)) || $fieldName == 'net_sales_value')   ): ?>
                                                                checked
                                                            <?php endif; ?>
                                                            <?php if($status_disanbeled_fields): ?>
                                                                disabled="disabled"
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/client_view/Exportation/fieldsSelectionToBeExported.blade.php ENDPATH**/ ?>