...
<div class="row">
    <div class="col-md-6" id="LoginForm">
        ...
        <div class="float-right" >
            <a href="<?php echo e(route('free.user.subscription')); ?>" class="btn "  style="margin: 19px;color: #fff;background-color: #1a5798;border-color: #007bff;"><?php echo e(__("Free Trail")); ?></a>
        </div>
...
<?php echo $__env->make('layouts.LoginDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/auth/login.blade.php ENDPATH**/ ?>