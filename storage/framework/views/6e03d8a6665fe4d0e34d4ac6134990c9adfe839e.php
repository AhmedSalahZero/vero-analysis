                            ...
                            <table class="table kt_table_with_no_pagination_no_collapse table-striped- table-bordered table-hover table-checkable position-relative table-with-two-subrows main-table-class dataTable no-footer">
                                <thead>
                                    ...
                                    <tr class="header-tr ">
                                        ...
                                        <?php echo $__env->make('admin.reports.invoice-report-th',['totalCollectionOrPaidText'=>$totalCollectionOrPaidText], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                ...
                                <tbody>
                                    ...
                                    <tr class=" parent-tr reset-table-width text-nowrap  cursor-pointer sub-text-bg text-capitalize is-close   ">
                                        ...
                                        <?php endif; ?>
                                         <?php echo $__env->make('admin.reports.invoice-report-td',['company'=>$company,'currency'=>$currency,'invoice'=>$invoice], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
