...
<th <?php echo e($attributes->merge(['class'=>'form-label font-weight-bold  text-center align-middle'])); ?>>
	...
	<span class="<?php echo e($fontSizeClass); ?>"><?php echo $title; ?></span>
    <?php if($helperTitle): ?>
    ...
    <span class="kt-input-icon__icon kt-input-icon__icon--right ml-2" tabindex="0" role="button" data-toggle="kt-tooltip" data-trigger="focus" >
        <span><i title="<?php echo e(__('Expand / Collapse')); ?>" class=" cursor-pointer fa fa-expand-arrows-alt text-primary exclude-icon"></i></span>
    </span>
    <?php endif; ?>
	</div>

</th>
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/components/tables/repeater-table-th.blade.php ENDPATH**/ ?>