...
<form class="kt-form kt-form--label-right" id="create-form" method="POST" action="<?php echo e(route('calculate.variable.at.end.and.beginning',['company' => $company->id])); ?>">
    ...
    <div class="kt-portlet">
        <div class="kt-portlet__body">
            ...
            <div class="row">
			<div class="col-md-3 item-main-parent">
                    <div class="form-group validated">
                        <label class="col-form-label take"><?php echo e(__('Loan Nature')); ?></label><span class="astric">*</span>
                        <div class="form-group-sub">
						
                            <select name="nature_type" id="nature_type" class="form-control">
                                <?php $__currentLoopData = ['variable_at_end'=>__('Variable At End') ,'variable_at_beginning'=>__('Variable At Beginning')]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $natureType => $natureTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($natureType); ?>" <?php echo e(isset($currentNatureType) && $currentNatureType == $natureType ? 'selected' : ''); ?> ><?php echo e($natureTitle); ?></option>
                    ...
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            <select name="installment_interval" id="installment_interval" class="form-control installment_condition">
                                ...
                                <option <?php if($loan && $loan->installment_interval == 'quartly'): ?> selected <?php endif; ?>
   ...
   <div class="col-md-4 item-main-parent">
                    <div class="form-group validated">
                        ...
                        <label class="col-form-label take"><?php echo e(__('Interest Payment Interval')); ?></label><span class="astric">*</span>
                        <div class="form-group-sub">
                            <select data-current-selected="<?php echo e($loan && $loan->interest_interval ? $loan->interest_interval : 'monthly'); ?>" name="interest_interval" id="interest_interval" class="form-control ">
                                <option value="" selected disabled><?php echo e(__('Select')); ?> ..</option>
                                <option <?php if($loan && $loan->interest_interval == 'monthly'): ?> selected <?php endif; ?>  value="monthly" <?php echo e(@old('interest_interval') == 'monthly' ? 'selected' : ''); ?> data-order="1"><?php echo e(__('Monthly')); ?></option>
                                <option  <?php if($loan && $loan->interest_interval == 'quartly'): ?> selected <?php endif; ?>  value="quartly" <?php echo e(@old('interest_interval') == 'quartly' ? 'selected' : ''); ?> data-order="2"><?php echo e(__('Quarterly')); ?></option>
                                <option  <?php if($loan && $loan->interest_interval == 'semi annually'): ?> selected <?php endif; ?> value="semi annually" <?php echo e(@old('interest_interval') == 'semi annually' ? 'selected' : ''); ?> data-order="3"><?php echo e(__('Semi-annually')); ?></option>
                            </select>
...
<table class='table table-striped table-bordered table-hover table-checkable'>
	<thead>
		   <th class="text-center font-weight-bold"><?php echo e(__("Payment No.")); ?></th>
                            <th class="text-center font-weight-bold"><?php echo e(__("Date")); ?></th>
                            <th class="text-center font-weight-bold"><?php echo e(__("Beginning Balance")); ?></th>
                            <th class="text-center font-weight-bold"><?php echo e(__("Interest Amount")); ?></th>
                            <th class="text-center font-weight-bold"><?php echo e(__("Schedule Payment")); ?></th>
                            <th class="text-center font-weight-bold"><?php echo e(__("Interest Payment")); ?></th>
                            <th class="text-center font-weight-bold"><?php echo e(__("Principle Payment")); ?></th>
                            <th class="text-center font-weight-bold"><?php echo e(__("End Balance")); ?></th>
	...
	?>
		...
		<tr>
			...
			<td class="text-center"><?php echo e($datesAsIndexString[$date]); ?></td>
			<td class="text-center"><?php echo e(number_format($result['beginning'][$date] ?? 0)); ?></td>
			<td class="text-center"><?php echo e(number_format($result['interestAmount'][$date] ?? 0)); ?></td>
			<td class="text-center"><?php echo e(number_format($result['schedulePayment'][$date] ?? 0)); ?></td>
			<td class="text-center"><?php echo e(number_format($result['interestPayment'][$date] ?? 0)); ?></td>
			<td class="text-center"><?php echo e(number_format($result['principleAmount'][$date] ?? 0)); ?></td>
			<td class="text-center"><?php echo e(number_format($result['endBalance'][$date] ?? 0)); ?></td>
		</tr>
		<?php
			$index++;
		?>
		...
		<tr class="custom-color-for-last-tr">
			...
			<th class="text-center"> <?php echo e(number_format($result['totals']['totalSchedulePayment'] ?? 0)); ?> </th>
			<th class="text-center"> <?php echo e(number_format($result['totals']['totalInterestAmount'] ?? 0)); ?> </th>
			<th class="text-center"> <?php echo e(number_format($result['totals']['totalPrincipleAmount'] ?? 0 )); ?> </th>
					<th>-</th>
...
<script>
    ...
    function installmentIntervalChange() {
        ...
        var select = '';
		var currentSelected = $('#interest_interval').attr('data-current-selected');
        if (interval != '') {
            ...
            if (interval == 'monthly') {
                select = `<option ${currentSelected == 'monthly' ? 'selected' : ''}  value="monthly">Monthly</option>\n`;
                ...
                select = `<option ${currentSelected == 'monthly' ? 'selected' : ''} value="monthly"><?php echo e(__("Monthly")); ?></option>\n` +
                    `<option  ${currentSelected == 'quartly' ? 'selected' : ''} value="quartly"><?php echo e(__("Quarterly")); ?></option>\n`;
                if (loan_amount != '' && repayment_duration != '') {
                ...
                select = `<option ${currentSelected == 'monthly' ? 'selected' : ''} value="monthly"><?php echo e(__("Monthly")); ?></option>\n` +
                    `<option  ${currentSelected == 'quartly' ? 'selected' : ''} value="quartly"><?php echo e(__("Quarterly")); ?></option>\n` +
                    `<option ${currentSelected == 'semi annually' ? 'selected' : ''} value="semi annually"><?php echo e(__("Semi-annually")); ?></option>\n`;
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/admin/loan2/variable.blade.php ENDPATH**/ ?>