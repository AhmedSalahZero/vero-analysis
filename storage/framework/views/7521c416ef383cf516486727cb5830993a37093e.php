    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-toolbar justify-content-between flex-grow-1">
            <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(!Request('active') || Request('active') == Partner::OTHER_PARTNERS ?'active':''); ?>" data-toggle="tab" href="#<?php echo e(Partner::OTHER_PARTNERS); ?>" role="tab">
                        <i class="fa fa-money-check-alt"></i> <?php echo e(__('Other Partners Table')); ?>
			...
			<?php if(auth()->user()->can('create other partners')): ?>
            <div class="flex-tabs">
               
                <a href="<?php echo e(route('other.partners.create',['company'=>$company->id,Partner::OTHER_PARTNERS])); ?>" class="btn  active-style btn-icon-sm align-self-center">
                        ...
                        <table class="table  table-striped- table-bordered table-hover table-checkable text-center kt_table_1">
                            <thead>
                                <tr class="table-standard-color">
									...
									<?php if(hasAuthFor('update other partners') 
									 // || hasAuthFor('delete other partners')
									 ): ?>
                                   ...
                                   <td class="text-nowrap text-left"><?php echo e($model->getName()); ?></td>
                                    ...
                                    <td class="kt-datatable__cell--left kt-datatable__cell " data-field="Actions" data-autohide-disabled="false">
                                        <span style="overflow: visible; position: relative; width: 110px;">
											<?php if(hasAuthFor('update other partners')): ?>
                                            <a type="button" class="btn btn-secondary btn-outline-hover-brand btn-icon" title="Edit" href="<?php echo e(route('other.partners.edit',['company'=>$company->id,'otherPartner'=>$model->id])); ?>"><i class="fa fa-pen-alt"></i></a>
											<?php endif; ?> 
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/otherPartners/index.blade.php ENDPATH**/ ?>