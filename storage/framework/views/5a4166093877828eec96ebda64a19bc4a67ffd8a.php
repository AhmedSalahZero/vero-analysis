...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('second.existing.products.allocations', $company)); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php $component->withAttributes([]); ?>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center active-style"><?php echo e(number_format(array_sum($percentages), 2) . ' %'); ?></td>
                        </tr>
                    <?php $__env->endSlot(); ?>
                                        ...
                                        <span class="kt-option__control">
                                            <span
                                                ...
                                                <input class="rows" name="use_modified_targets" type="checkbox"
                                                    value="1"
                                                    <?php echo e(($existing_allocations_base['use_modified_targets']??(old('use_modified_targets'))) == 0 ?: 'checked'); ?>
                        ...
                        <?php $__currentLoopData = $breakdown_base_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <?php if($allocations_setting->breakdown !== 'new_breakdown_annually'): ?>
                                    ...
                                    <input type="hidden" name="existing_products_target[<?php echo e($product_data['item']); ?>]"
                                        value="<?php echo e($existing_target_per_product); ?>">
                                ...
                                <?php if($allocations_setting->breakdown !== 'new_breakdown_quarterly'): ?>
                                    ...
                                    <td class="text-center light-gray-bg">
                                        <input type="number" name="modify_sales_target[<?php echo e($product_data['item']); ?>]"
                                            ...
                                            class="modify_sales_target_percentage form-control" value="<?php echo e($percentage); ?>">
                                    </td>
                                <?php else: ?>
                                    <?php $__currentLoopData = $sales_targets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quarter_name => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/client_view/forecast/second_existing_products_allocation_base.blade.php ENDPATH**/ ?>