...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('main-form-title'),'class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('')]); ?><?php echo e($tableNameFormatted .' ' . __('Withdrawals Settlement Report')); ?> <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
...
<div class="row">
 ...
 <th class="view-table-th max-w-invoice-date max-w-report-btn    header-th  align-middle text-center">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $overdraftWithdrawals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$modelAsStdClass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class=" parent-tr reset-table-width text-nowrap  cursor-pointer sub-text-bg text-capitalize is-close   ">
                                        <td class="sub-text-bg max-w-serial   "><?php echo e($index+1); ?></td>
                                        <td class="sub-text-bg text-center max-w-amount"><?php echo e($modelAsStdClass->name_en); ?></td>
										
                                        <td class="sub-text-bg text-center max-w-invoice-number"><?php echo e($tableNameFormatted); ?></td>
                                        <td class="sub-text-bg text-center max-w-invoice-date"><?php echo e($modelAsStdClass->account_number); ?></td>
                                        <td class="sub-text-bg  text-center "><?php echo e(\Carbon\Carbon::make($modelAsStdClass->date)->format('d-m-Y')); ?></td>
                                        <td class="sub-text-bg text-center max-w-amount"><?php echo e(number_format($modelAsStdClass->credit)); ?></td>
                                        <td class="sub-text-bg text-center max-w-amount"><?php echo e(number_format($modelAsStdClass->settlement_amount)); ?></td>
                                        <td class="sub-text-bg text-center max-w-amount"><?php echo e(number_format($modelAsStdClass->net_balance)); ?></td>
                                        <td class="sub-text-bg  text-center "><?php echo e(\Carbon\Carbon::make($modelAsStdClass->due_date)->format('d-m-Y')); ?></td>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/withdrawal_settlement_report_result.blade.php ENDPATH**/ ?>