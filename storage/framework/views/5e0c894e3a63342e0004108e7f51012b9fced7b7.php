<div class="modal fade inner-modal-class" id="edit-rates-<?php echo e($rate->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <form action="<?php echo e(route('overdraft-against-assignment-of-contract-edit-rates',['company'=>$company->id,'financialInstitution'=>$financialInstitution->id,'rate'=>$rate->id ])); ?>" method="post">
                                                <?php echo csrf_field(); ?>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button data-url="<?php echo e(route('overdraft-against-assignment-of-contract-edit-rates',['company'=>$company->id,'financialInstitution'=>$financialInstitution->id,'rate'=>$rate->id])); ?>" type="submit" class="btn btn-primary submit-form-btn"><?php echo e(__('Confirm')); ?></button>
                                                </div>
...
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/reports/overdraft-against-assignment-of-contract/rate-modal.blade.php ENDPATH**/ ?>