...
<?php endif; ?> 
                                ...
                                <div class="col-md-2 ">
                                    ...
                                    <div class="kt-input-icon">
                                        <div class="input-group">
                                            <input required name="duration" type="numeric" class="form-control duration recalc-end-date duration " value="<?php echo e(ceil(old('duration',isset($model) ? $model->getDuration() * (12/365) : null))); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2 ">
