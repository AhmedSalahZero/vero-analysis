                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2 ">
                                    ...
                                    <div class="kt-input-icon">
                                        <div class="input-group">
                                            <input required name="code" type="text" class="form-control " value="<?php echo e(isset($model) ? $model->getCode() : old('code',null)); ?>">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="kt-input-icon">
                                            <div class="input-group date">
                                                <select data-live-search="true" data-actions-box="true" id="customer_name" name="partner_id" class="form-control select2-select">
                                                    ...
                                                    <option <?php if(isset($model) && $model->getClientName() == $customer->getName() ): ?> selected <?php endif; ?> value="<?php echo e($customer->id); ?>"><?php echo e($customer->getName()); ?></option>
                                ...
                                <div class="col-md-2 ">
                                     <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.date','data' => ['type' => 'text','classes' => 'datepicker-input recalc-end-date start-date','defaultValue' => formatDateForDatePicker(isset($model)  ? $model->getStartDate() : now()),'model' => $model??null,'label' => __('Start Date'),'placeholder' => __(''),'name' => 'start_date','required' => true]]); ?>
<?php $component->withName('form.date'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('text'),'classes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('datepicker-input recalc-end-date start-date'),'default-value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(formatDateForDatePicker(isset($model)  ? $model->getStartDate() : now())),'model' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($model??null),'label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Start Date')),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('')),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('start_date'),'required' => true]); ?> <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?> 
                                ...
                                <div class="col-md-2 ">
                                    ...
                                    <div class="kt-input-icon">
                                        <div class="input-group">
                                            <input required name="duration" type="numeric" class="form-control duration recalc-end-date duration " value="<?php echo e(isset($model) ? $model->getDuration() : old('duration',null)); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2 ">
                                    ...
                                    <div class="kt-input-icon">
                                        <div class="input-group">
                                            <input id="end-date" disabled name="end_date" type="text" class="form-control datepicker-input" value="<?php echo e(isset($model) ? $model->getEndDate() : old('end_date',null)); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 ">
                                    ...
                                    <div class="kt-input-icon">
                                        <div class="input-group">
                                            <input required name="amount" type="text" class="form-control only-greater-than-or-equal-zero-allowed" value="<?php echo e(isset($model) ? $model->getAmount() : old('amount',0)); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-1 ">
                                ...
                                <div class="col-md-1 ">
                                    ...
                                    <div class="kt-input-icon">
                                        <div class="input-group">
                                            <input required name="exchange_rate" type="text" class="form-control only-greater-than-or-equal-zero-allowed" value="<?php echo e(isset($model) ? $model->getExchangeRate() : old('exchange_rate',1)); ?>">
                                        </div>
                                    </div>
                                </div>
...
<?php endif; ?> 
            ...
            <div class="kt-portlet" id="connecting">
                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title head-title text-primary">
                            <?php echo e(__('Connecting With Suppliers Contracts')); ?>
...
<?php endif; ?> 
                             ...
                             <?php $__env->slot('trs'); ?> 
                                ...
                                <tr <?php if($isRepeater): ?> data-repeater-item <?php endif; ?>>
                                    ...
                                    <td>
                                         <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.select','data' => ['selectedValue' => isset($currentContract) && $currentContract->client ? $currentContract->client->id : '','options' => formatOptionsForSelect($clientsWithContracts),'addNew' => false,'class' => 'select2-select suppliers-or-customers-js repeater-select  ','dataFilterType' => ''.e($type).'','all' => false,'name' => '@if($isRepeater) partner_id @else '.e($tableId).'[0][partner_id] @endif']]); ?>
<?php $component->withName('form.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['selectedValue' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(isset($currentContract) && $currentContract->client ? $currentContract->client->id : ''),'options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(formatOptionsForSelect($clientsWithContracts)),'add-new' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'class' => 'select2-select suppliers-or-customers-js repeater-select  ','data-filter-type' => ''.e($type).'','all' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'name' => '@if($isRepeater) partner_id @else '.e($tableId).'[0][partner_id] @endif']); ?> <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
