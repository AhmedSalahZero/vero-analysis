    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="kt-form kt-form--label-right" method="POST"
                action=<?php if($name_of_selector_label == 'Sales Discount'): ?> <?php echo e(route('categories.salesDiscount.analysis.result', $company)); ?>

                       <?php elseif($type == 'averagePrices'): ?> <?php echo e(route('averagePrices.result', $company)); ?>

                       <?php else: ?> <?php echo e(route('categories.analysis.result', $company)); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/client_view/reports/sales_gathering_analysis/categories_analysis_form.blade.php ENDPATH**/ ?>