  <div class="form-group row align-items-end">
      ...
      <div class="col-md-2 closest-parent">
          <label><?php echo e(__('Amount')); ?> <span class="contract-currency"> </label>
          <div class="kt-input-icon">
      ...
      <div class="col-md-2 closest-parent">
          <label><?php echo e(__('Paid Amount')); ?> 
		  <span class="contract-currency"> </label>
		  <?php echo $__env->make('star', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></label>
          <div class="kt-input-icon">
