...
<div class="row">
    <div class="col-md-12">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="POST" action="<?php echo e($type == 'sales_discount' ? route('intervalComparing.salesDiscounts.analysis.result',$company) : route('intervalComparing.analysis.result',$company)); ?>"   enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                ...
                <div class="kt-portlet__body">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date">
                                    <input type="date" name="start_date_one"  required value="<?php echo e(getEndYearBasedOnDataUploaded($company)['jan']); ?>"  class="form-control"  placeholder="Select date" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date">
                                    <input type="date" name="end_date_one"   required value="<?php echo e(getEndYearBasedOnDataUploaded($company)['dec']); ?>" max="<?php echo e(date('Y-m-d')); ?>"  class="form-control"  placeholder="Select date" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date">
                                    <input type="date" name="start_date_two"  required value="<?php echo e(getEndYearBasedOnDataUploaded($company,1)['jan']); ?>"  class="form-control"  placeholder="Select date" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date">
                                    <input type="date" name="end_date_two"  required  value="<?php echo e(getEndYearBasedOnDataUploaded($company,1)['dec']); ?>" max="<?php echo e(date('Y-m-d')); ?>"  class="form-control"  placeholder="Select date" />
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/client_view/reports/sales_gathering_analysis/interval_comparing/sales_form.blade.php ENDPATH**/ ?>