            ...
            <div class="row row-no-padding row-col-separator-xl">
                ...
                <div class="col-md-6 col-lg-4 col-xl-4">
                    ...
                    <div class="kt-widget24">
                        ...
                        <div class="progress progress--sm">
                            <div class="progress-bar kt-bg-dark" role="progressbar" style="width: 100%;"
                ...
                <div class="col-md-6 col-lg-4 col-xl-4">
                    ...
                    <div class="kt-widget24">
                        ...
                        ?>
                        <div class="progress progress--sm">
                            <div class="progress-bar kt-bg-danger" role="progressbar" style="width: <?php echo e($percentage); ?>%;"
                                aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="kt-widget24__action">
                            <span class="kt-widget24__change">
                ...
                <div class="col-md-6 col-lg-6 col-xl-6">
                    ...
                    <div class="kt-widget24 text-center">
                        ...
                        <div class="progress progress--sm">
                            <div class="progress-bar kt-bg-brand" role="progressbar" style="width: 100%;" aria-valuenow="50"
                    ...
                    <div class="kt-widget24">
                        <div class="kt-widget24__details">
                            <div class="kt-widget24__info">
                                ...
                                <h4 class="kt-widget24__title font-size">
                                    <?php echo e(__('Previous Month')); ?> : ( <?php echo e(\Carbon\Carbon::make($end_date)->startOfMonth()->subMonth(1)->format('M')); ?> )
                                </h4>
...
<?php $component->withAttributes(['fixedColumns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([])]); ?>
                                ...
                                <?php array_shift($monthlyChartArr) ?> 
                                    ...
                                    <?php if(isset($values) && is_null($values[0])): ?>
                                            ...
                                            <td colspan="<?php echo e(count($values) + 2); ?>"><b
                                                    class="white-text"><?php echo e(__($title)); ?></b></td>
                                        ...
                                        <?php else: ?>
                                         ...
                                         <tr class=" text-lg-left  ">
                                            <td ><b
                                                    class=""><?php echo e(__($title)); ?></b></td>
...
<?php endif; ?>
                                ...
                                <input type="hidden" id="accumulated_data"
                                    data-total="<?php echo e(json_encode($monthlyChartCumulative ?? [])); ?>">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/client_view/home_dashboard/dashboard.blade.php ENDPATH**/ ?>