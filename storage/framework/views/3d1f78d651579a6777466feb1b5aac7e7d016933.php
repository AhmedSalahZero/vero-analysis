...
<body>
    <a title="<?php echo app('translator')->get('HOME'); ?>" class="style" href="<?php echo e(route('home')); ?>">
        ...
        <div class="container">
            <div class="left-section">
                <div class="inner-content">
                    ...
                    <p class="subheading"><?php echo e($message['en'] ?? 'Looks like the page you were looking for is not Found'); ?></p>
                    <p class="subheading"><?php echo e($message['ar'] ?? '.يبدو أن الصفحة التي تبحث غير موجودة'); ?></p>
                </div>
            </div>
...
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/errors/404.blade.php ENDPATH**/ ?>