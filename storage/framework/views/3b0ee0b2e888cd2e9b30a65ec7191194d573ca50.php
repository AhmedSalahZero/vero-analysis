                    ...
                    <div class="col-md-2">
                        ...
                        <div class="kt-input-icon">
                            <div class="input-group date">
                                <input type="date" name="start_date" required value="<?php echo e(getEndYearBasedOnDataUploaded($company,1)['jan']); ?>" class="form-control" placeholder="Select date" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        ...
                        <div class="kt-input-icon">
                            <div class="input-group date">
                                <select name="report_type" required class="form-control">
                                    ...
                                    <option value="trend"><?php echo e(__('Monthly Trend')); ?></option>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/client_view/reports/sales_gathering_analysis/sales_report/sales_form.blade.php ENDPATH**/ ?>