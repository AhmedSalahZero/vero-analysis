                        ...
                        <div class="row">
                            <div <?php if(!isset($model)): ?> id="m_repeater_2" <?php endif; ?> class="w-100">
                                <div class="form-group  m-form__group row">
                                    <div <?php if(!isset($model)): ?> data-repeater-list="expenses" <?php endif; ?> class="col-lg-12">
                                        <div data-repeater-item class="form-group m-form__group row align-items-center repeater_item">
                                            ...
                                            <div class="col-md-6">
                                                <label><?php echo e(__('Expense Type')); ?><span class="astric">*</span></label>
                                                <div class="m-form__group m-form__group--inline">
                                                    <div class="m-form__control">
                                                        <select name="expense_type" class="form-control">
                                                            <?php $__currentLoopData = $expenseTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($id); ?>" <?php if(isset($model )? $id==$model->expense_type :false ): ?> selected <?php endif; ?> ><?php echo e($name); ?></option>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/admin/expenses/crud.blade.php ENDPATH**/ ?>