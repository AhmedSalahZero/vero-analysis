                                     ...
                                     <tbody>
                                         ...
                                         <tr>
                                             ...
                                             <td>
                                                 ...
                                                 <div class="modal fade" id="edit-advanced-payment-lg-<?php echo e($advancedPaymentHistory->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                     <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                                         <div class="modal-content">
                                                 ...
                                                 <div class="modal fade" id="delete-advanced-payment-lg-<?php echo e($advancedPaymentHistory->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
 ...
 <?php endif; ?>
 <a data-toggle="modal" data-target="#cancel-deposit-modal-<?php echo e($model->id); ?>" type="button" class="btn  btn-secondary btn-outline-hover-success   btn-icon" title="<?php echo e(__('Cancel Letter')); ?>" href="#"><i class="fa fa fa-ban"></i></a>
 ...
 <?php endif; ?>
<?php /**PATH C:\laragon\www\veroo\resources\views/reports/LetterOfGuaranteeIssuance/actions.blade.php ENDPATH**/ ?>