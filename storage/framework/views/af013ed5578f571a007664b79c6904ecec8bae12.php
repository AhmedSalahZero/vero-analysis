        ...
        <tr>
            ...
            <td class="kt-datatable__cell--left kt-datatable__cell " data-field="Actions" data-autohide-disabled="false">
                ...
                <span class="d-flex justify-content-center" style="overflow: visible; position: relative; width: 110px;">
                    ...
                    <form class="kt-portlet__body" method="post" action="<?php echo e(route('salesGathering.destroy',[$company->id,$item->id,$modelName])); ?>" style="display: inline">
                        ...
                        <?php echo method_field('DELETE'); ?>
                        <?php echo csrf_field(); ?>
						<input type="hidden" name="modelType" value="<?php echo e($modelName); ?>">
