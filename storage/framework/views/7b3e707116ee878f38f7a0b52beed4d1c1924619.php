...
<div class="kt-portlet__head-toolbar">
    <div class="kt-portlet__head-wrapper">
        <div class="kt-portlet__head-actions">
            ...
            <?php if($hasSearch): ?>
            <a data-type="multi" data-toggle="modal" data-target="#search-modal-<?php echo e($type); ?>" id="js-search-money-received" href="#" title="<?php echo e(__('Search Letter Of Guarantee Issuance')); ?>" class="btn  active-style btn-icon-sm  ">
                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo csrf_field(); ?>
                            <form action="<?php echo e(route('view.letter.of.guarantee.issuance',['company'=>$company->id,'active'=>$type])); ?>" class="row ">
...
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/components/export-letter-of-guarantee-issuance.blade.php ENDPATH**/ ?>