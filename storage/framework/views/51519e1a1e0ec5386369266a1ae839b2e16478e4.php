<div class="row " id="contract-row-id">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select data-current-selected="<?php echo e(isset($model)  ? $model->getContractId() :0); ?>" name="contract_id" id="contract-id" class="form-control ajax-get-sales-orders-for-contract">
            </select>
        </div>
    </div>
