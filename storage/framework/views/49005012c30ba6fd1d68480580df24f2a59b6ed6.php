                ...
                <div class="col-md-3">
                    ...
                    <div class="kt-input-icon">
                        <div class="input-group date">
                            <input type="text" name="payment_date" value="<?php echo e(isset($model) ? formatDateForDatePicker($model->getPaymentDate()) : formatDateForDatePicker(now()->format('Y-m-d'))); ?>" class="form-control is-date-css exchange-rate-date update-exchange-rate" readonly placeholder="Select date" id="kt_datepicker_2" />
