            ...
            <div class="kt-portlet__head-label flex-1">
				...
				<div class=" flex-1 d-flex justify-content-end pt-3">
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="kt-input-icon">
                                    <input value="0" type="text" disabled class="form-control cash-balance-js" data-type="<?php echo e(CashExpense::PAYABLE_CHEQUE); ?>" placeholder="<?php echo e(__('Account Balance')); ?>">
                                </div>
                            </div>
