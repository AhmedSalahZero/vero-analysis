                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo csrf_field(); ?>
                            <form action="<?php echo e(route('buy-or-sell-currencies.index',['company'=>$company->id ])); ?>"  class="row ">
...
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/components/export-buy-or-sell-currency.blade.php ENDPATH**/ ?>