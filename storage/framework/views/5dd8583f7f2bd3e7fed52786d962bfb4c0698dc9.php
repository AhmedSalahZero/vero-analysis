        ...
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                <h3 class="kt-portlet__head-title head-title text-primary">
                    <?php echo e(__('Cash Inflow/Outflow Forecast')); ?>
            ...
            <form action="">
                <div class="row ">
                    <div class="col-md-3 ">
                        ...
                        <div class="kt-input-icon">
                            <div class="input-group date">
                                <input required type="date" class="form-control" name="start_date" value="<?php echo e($startDate); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="kt-input-icon">
                            <div class="input-group date">
                                <input required type="date" class="form-control" name="end_date" value="<?php echo e($endDate); ?>">
                            </div>
                        </div>
                    </div>
					<div class="col-md-3">
...
<div class="row">
    <div class="kt-portlet ">
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                <h3 class="kt-portlet__head-title head-title text-primary">
                    <?php echo e(__('Monthly Accumulated Cash Flow')); ?>
    ...
    <div class="kt-portlet ">
        ...
        <div class="kt-portlet__body">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="chartdivchart" id="chartdiv3_<?php echo e($modelType.$currency); ?>"></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="kt-portlet ">
            <div class="kt-portlet__head">
                ...
                <div class="kt-portlet__head-label ">
                    <div class="kt-align-right">
							...
							<?php echo csrf_field(); ?>
							  <input type="hidden" class="form-control" name="start_date" value="<?php echo e(now()->format('Y-m-d')); ?>">
							      <input type="hidden" class="form-control" name="end_date" value="<?php echo e(now()->addMonths(\App\Http\Controllers\WithdrawalsSettlementReportController::NUMBER_OF_INTERNAL_MONTHS)->format('Y-m-d')); ?>">
            ...
            <div class="kt-portlet__body">
				...
				<div class="col-md-10 mb-3">
                        <select name="account_type" data-currency="<?php echo e($currency); ?>"  js-refresh-withdrawal-due-data-and-chart class="form-control ">
    ...
    <div class="col-md-4">
        <div class="kt-portlet ">
            <div class="kt-portlet__head">
                <div class="kt-portlet__head-label">
                    <h3 class="kt-portlet__head-title head-title text-primary">
                        <?php echo e(__('Leasing Facilities Comming Dues')); ?>
            ...
            <div class="kt-portlet__body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="chartdivchart" id="chartdivline6<?php echo e($currency); ?>"></div>
                        </div>
                    </div>
...
<script>
    am4core.ready(function() {
        ...
        var chart = am4core.create("chartdiv3_<?php echo e($modelType.$currency); ?>", am4charts.XYChart);
...
<script>
    am4core.ready(function() {
        ...
        // Create chart instance
        var chart = am4core.create("chartdivline1<?php echo e($currencyUpper); ?>", am4charts.XYChart);
...
<script>
    am4core.ready(function() {
        ...
        // Create chart instance
        var chart = am4core.create("withdrawal-dues-chart-<?php echo e($currencyUpper); ?>", am4charts.XYChart);
...
<script>
    am4core.ready(function() {
        ...
        // Create chart instance
        var chart = am4core.create("chartdivline5<?php echo e($currencyUpper); ?>", am4charts.XYChart);
...
<script>
    am4core.ready(function() {
        ...
        // Create chart instance
        var chart = am4core.create("chartdivline6<?php echo e($currencyUpper); ?>", am4charts.XYChart);
...
<script>
    am4core.ready(function() {
        ...
        // Create chart instance
        var chart = am4core.create("chartdivmulti<?php echo e($currencyUpper); ?>", am4charts.XYChart);
	...
	$(document).on('change','select[js-refresh-withdrawal-due-data-and-chart][data-currency="<?php echo e($currency); ?>"]',function(){
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\veroo\resources\views/admin/dashboard/forecast.blade.php ENDPATH**/ ?>