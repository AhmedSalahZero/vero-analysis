    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="kt-form kt-form--label-right" method="POST"
                action=<?php if($name_of_selector_label == 'Sales Discount'): ?> <?php echo e(route('zone.salesDiscount.analysis.result', $company)); ?>

                        <?php elseif(($type == 'averagePrices') || ($type == 'averagePricesProductItems')): ?> <?php echo e(route('averagePrices.result', $company)); ?>

                        <?php else: ?> <?php echo e(route('zone.analysis.result', $company)); ?>
                                    ...
                                    <div class="kt-input-icon">
                                        <div class="input-group date" id="categories">
                                            <select data-live-search="true"   data-actions-box="true" name="categories[]" 
                                             ...
                                             class="form-control select2-select form-select form-select-2 form-select-solid fw-bolder" multiple>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/client_view/reports/sales_gathering_analysis/zone_analysis_form.blade.php ENDPATH**/ ?>