                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo csrf_field(); ?>
                            <form action="<?php echo e(route('internal-money-transfers.index',['company'=>$company->id ])); ?>"  class="row ">
...
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/components/export-internal-money-transfer.blade.php ENDPATH**/ ?>