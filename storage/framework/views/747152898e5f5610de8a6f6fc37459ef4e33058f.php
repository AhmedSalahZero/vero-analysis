...
<div class="kt-portlet kt-portlet--tabs">
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-toolbar justify-content-between flex-grow-1">
            <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(!Request('active') || Request('active') == CashVeroBusinessUnit::BUSINESS_UNITS ?'active':''); ?>" data-toggle="tab" href="#<?php echo e(CashVeroBusinessUnit::BUSINESS_UNITS); ?>" role="tab">
            ...
            <div class="flex-tabs">
                ...
                <a href="<?php echo e(route($createRouteName,['company'=>$company->id,CashVeroBusinessUnit::BUSINESS_UNITS])); ?>" class="btn  active-style btn-icon-sm align-self-center">
                    <i class="fas fa-plus"></i>
                    <?php echo e(__('Business Unit')); ?>
    ...
    <div class="kt-portlet__body">
        <div class="tab-content  kt-margin-t-20">
            ...
            <?php
            $currentType = CashVeroBusinessUnit::BUSINESS_UNITS ;
            ?>
            <!--Begin:: Tab Content-->
...
<?php $component->withAttributes(['type' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($currentType),'title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title),'startDate' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($filterDates[$currentType]['startDate']??''),'endDate' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($filterDates[$currentType]['endDate']??'')]); ?>
                         <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.export-business-units','data' => ['indexRouteName' => $indexRouteName,'searchFields' => $searchFields[$currentType],'moneyReceivedType' => $currentType,'hasSearch' => 1,'hasBatchCollection' => 0,'href' => ''.e($createRoute).'']]); ?>
<?php $component->withName('export-business-units'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="kt-datatable__cell--left kt-datatable__cell " data-field="Actions" data-autohide-disabled="false">
                                        <span style="overflow: visible; position: relative; width: 110px;">
                                            ...
                                            <a type="button" class="btn btn-secondary btn-outline-hover-brand btn-icon" title="Edit" href="<?php echo e(route($editModelName,['company'=>$company->id,'businessUnit'=>$model->id])); ?>"><i class="fa fa-pen-alt"></i></a>
											<?php endif; ?> 
                                            ...
                                            <div class="modal fade" id="delete-customer-<?php echo e($model->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <form action="<?php echo e(route($deleteRouteName,['company'=>$company->id,'businessUnit'=>$model->id ])); ?>" method="post">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/business_units/index.blade.php ENDPATH**/ ?>