...
<div class="row">
    <div class="col-12">
        ...
        <div class="kt-portlet">
            ...
            action=<?php if(isset($company_row)): ?>
                    <?php if(isset($companySection) ): ?>
                        <?php echo e(route('edit.admin.company',[$company_row,$companySection])); ?>

                    <?php else: ?>
                        <?php echo e(route('admin.company',$company_row)); ?>

                    <?php endif; ?>
                <?php elseif(isset($companySection) ): ?>
                    <?php echo e(route('companySection.update',$companySection)); ?>

                <?php else: ?>
                    <?php echo e(route('companySection.store')); ?>
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row col-12">
                            <?php $__currentLoopData = $langs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-6">
                                    <label><?php echo e(__('Company Name ') . $lang_row->name); ?> <span class="required">*</span></label>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row col-12">
                            ...
                            <div class="col-12">
                                <label><?php echo e(__('Company Image')); ?> <span class="required">*</span></label>
                                <div class="kt-input-icon">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/super_admin_view/companies/form.blade.php ENDPATH**/ ?>