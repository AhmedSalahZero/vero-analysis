                            ...
                            <?php $__env->slot('table_body'); ?>
                                <tr>
                                    ...
                                    <?php $__currentLoopData = $sales_forecast['last_3_years_seasonality'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td class="text-center">
                                            <?php echo e($sum_totals ? number_format(($total / $sum_totals) * 100 , 2) . ' %' : 0); ?>

                                        </td>
                                        <input type="hidden" name="last_3_years_seasonality[<?php echo e($month); ?>]"
                                            value="<?php echo e($sum_totals ? ($total / $sum_totals) * 100  : 0); ?>">
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tr>
                            <?php $__env->endSlot(); ?>
                         <?php if (isset($__componentOriginale53a9d2e6d6c51019138cc2fcd3ba8ac893391c6)): ?>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3"
                                ...
                                <label><?php echo e(__('Growth Rate %')); ?> <?php echo $__env->make('star', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></label>
                            ...
                            <div class="col-md-<?php echo e(@$sales_forecast_data['new_start'] == 'annual_target' && @$sales_forecast_data['target_base'] == 'new_start'? '6': '3'); ?>"
                                ...
                                <label><?php echo e(__('Annual Sales Target')); ?> <?php echo $__env->make('star', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></label>
                                <div class="kt-input-icon">
                        ...
                        <div class="row">
                                    ...
                                    <span class="kt-option__control">
                                        <span
                                            ...
                                            <input class="rows" name="add_new_products" type="checkbox" value="1"
                                                ...
                                                id="product_item_check_box" data-old-checked="<?php echo e(@$sales_forecast_data['add_new_products']?:0); ?>">
                                            <span></span>
                                        </span>
                                    </span>
                            ...
                            <div class="col-md-6"
                                ...
                                id="number_of_products_field" data-old-value="<?php echo e(@$sales_forecast_data['number_of_products'] ?: 0); ?>">
...
// alert(oldNewProductsItems != newProductsItems);
    ...
    <script>
        ...
        //     e.preventDefault();
        //     $('form').attr('action'  , "<?php echo e(route('go.to.summary.report' , $company->id)); ?>");
        //     $('form').submit();
        // });
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\veroo\resources\views/client_view/forecast/sales_forecast.blade.php ENDPATH**/ ?>