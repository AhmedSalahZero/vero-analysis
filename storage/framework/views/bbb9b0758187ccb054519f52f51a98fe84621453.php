                                ...
                                <td data-column-index="<?php echo e($dateAsIndex); ?>">
                                    ...
                                    <div data-column-index="<?php echo e($dateAsIndex); ?>" class="d-flex align-items-center justify-content-center flex-column" style="gap:10px">
										...
										<?php $__currentLoopData = $currentTableData['main_items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mainItemTitle => $mainItemArr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.repeat-right-dot-inputs','data' => ['readonly' => false,'classes' => $mainItemArr['options']['classes']??$defaultClasses[$currentIndex]['classes'],'dataGroupIndex' => ''.e($currentIndex ==0   ? $currentYearRepeaterIndex : -1).'','formattedInputClasses' => $mainItemArr['options']['formatted-input-classes']??$defaultClasses[$currentIndex]['formatted-input-classes'],'removeThreeDots' => true,'removeCurrency' => true,'mark' => ' ','isNumber' => true,'removeThreeDotsClass' => true,'numberFormatDecimals' => $mainItemArr['options']['number-format-decimals']??$defaultClasses[$currentIndex]['number-format-decimals'],'currentVal' => $mainItemArr['data'][$dateAsIndex]??0,'isPercentage' => $mainItemArr['options']['is-percentage']??$defaultClasses[$currentIndex]['is-percentage'],'name' => '','columnIndex' => $dateAsIndex]]); ?>
<?php $component->withName('repeat-right-dot-inputs'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['readonly' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'classes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($mainItemArr['options']['classes']??$defaultClasses[$currentIndex]['classes']),'data-group-index' => ''.e($currentIndex ==0   ? $currentYearRepeaterIndex : -1).'','formattedInputClasses' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($mainItemArr['options']['formatted-input-classes']??$defaultClasses[$currentIndex]['formatted-input-classes']),'removeThreeDots' => true,'removeCurrency' => true,'mark' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(' '),'is-number' => true,'removeThreeDotsClass' => true,'numberFormatDecimals' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($mainItemArr['options']['number-format-decimals']??$defaultClasses[$currentIndex]['number-format-decimals']),'currentVal' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($mainItemArr['data'][$dateAsIndex]??0),'is-percentage' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($mainItemArr['options']['is-percentage']??$defaultClasses[$currentIndex]['is-percentage']),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(''),'columnIndex' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($dateAsIndex)]); ?> <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?> 
                                ...
                                <td data-column-index="<?php echo e($dateAsIndex); ?>" class="exclude-from-collapse">
                                    <div class="d-flex align-items-center justify-content-center">
                                         <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.repeat-right-dot-inputs','data' => ['readonly' => true,'removeThreeDots' => true,'numberFormatDecimals' => 0,'mark' => ' ','currentVal' => 0 ,'formattedInputClasses' => 'exclude-from-collapse repeat-group-year','classes' => 'year-repeater-index-'.$currentYearRepeaterIndex.' ' .'only-greater-than-or-equal-zero-allowed exclude-from-collapse','isPercentage' => true,'name' => '','columnIndex' => $dateAsIndex]]); ?>
<?php $component->withName('repeat-right-dot-inputs'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['readonly' => true,'removeThreeDots' => true,'number-format-decimals' => 0,'mark' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(' '),'currentVal' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(0 ),'formattedInputClasses' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('exclude-from-collapse repeat-group-year'),'classes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('year-repeater-index-'.$currentYearRepeaterIndex.' ' .'only-greater-than-or-equal-zero-allowed exclude-from-collapse'),'is-percentage' => true,'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(''),'columnIndex' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($dateAsIndex)]); ?> <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
