...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('main-form-title'),'class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('')]); ?><?php echo e(__('Loan Schedule Payment')); ?> <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
            ...
            <div class="kt-portlet__body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!--begin::Form-->
                        <form method="post" action="<?php echo e(isset($model) ? route('update.loan.schedule.settlements',['company'=>$company->id,'loanScheduleSettlement'=>$model->id]) :route('store.loan.schedule.settlements',['company'=>$company->id,'loanSchedule'=>$loanSchedule->id ])); ?>" class="kt-form kt-form--label-right">
                            <?php echo csrf_field(); ?>
                            <?php if(isset($model)): ?>
                                ...
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title head-title text-primary">
                                            <?php echo e(__('Loan Schedule Payment')); ?>
                                    ...
                                    <table class="table kt_table_with_no_pagination_no_collapse table-for-currency  table-striped- table-bordered table-hover table-checkable position-relative table-with-two-subrows main-table-class-for-currency dataTable no-footer">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class=" parent-tr reset-table-width text-nowrap  cursor-pointer sub-text-bg text-capitalize is-close   ">
                                                ...
                                                ?>
                                                <td class="sub-text-bg  text-center max-w-counts "><?php echo e($settlement->getAccountNumber()); ?></td>
                                                <td class="sub-text-bg  text-center max-w-counts "><?php echo e($settlement->getAmountFormatted()); ?></td>
                                                <td class="sub-text-bg  text-center max-w-action   ">
                                                    <?php if($loop->last): ?>
                                                    <a type="button" class="btn btn-secondary btn-outline-hover-brand btn-icon" title="Edit" href="<?php echo e(route('edit.loan.schedule.settlements',['company'=>$company->id,'loanScheduleSettlement'=>$settlement->id])); ?>"><i class="fa fa-pen-alt"></i></a>
                                                    <a class="btn btn-secondary btn-outline-hover-danger btn-icon  " href="#" data-toggle="modal" data-target="#modal-delete-<?php echo e($settlement['id']); ?>" title="Delete"><i class="fa fa-trash-alt"></i>
                                                    </a>
                                                    <?php endif; ?>

                                                    <div id="modal-delete-<?php echo e($settlement['id']); ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title"><?php echo e(__('Delete Loan Schedule Settlement ' .$settlement->getDateFormatted())); ?></h4>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <h3><?php echo e(__('Are You Sure To Delete This Item ? ')); ?></h3>
                                                                </div>
                                                                <form action="<?php echo e(route('delete.loan.schedule.settlements',['company'=>$company->id,'loanScheduleSettlement'=>$settlement->id])); ?>" method="post" id="delete_form">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/admin/loan-schedule-settlements/index.blade.php ENDPATH**/ ?>