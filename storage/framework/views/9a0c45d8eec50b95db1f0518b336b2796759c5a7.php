...
<?php $component->withAttributes([]); ?>
                        <?php $__env->slot('table_header'); ?>
                            <tr class="table-active">
                                ...
                                <?php $__currentLoopData = $total_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php $__env->slot('table_body'); ?>
                            <?php $__currentLoopData = $final_report_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category_name => $zoone_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="group-color text-lg-left  ">
                                    <td colspan="<?php echo e(count($total_categories) + 1); ?>"><b
                                            class="white-text"><?php echo e(__($category_name)); ?></b>
                                    </td>
                                    <?php $__currentLoopData = $total_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td class="hidden"> </td>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <input type="hidden" id="<?php echo e(str_replace(' ', '_', $category_name)); ?>_data"
                            ...
                            <tr>
                                ...
                                <?php $chart_data = []; ?>
                                <?php $__currentLoopData = $total_categories_growth_rates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    $chart_data[] = [
                                        'date' => date('d-M-Y', strtotime($date)),
...
<?php $component->withAttributes([]); ?>
                        ...
                        <?php $__env->slot('table_body'); ?>
                            ...
                            <?php $__currentLoopData = $final_report_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category_name => $zoone_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="group-color text-lg-left  ">
                                    <td colspan="<?php echo e(count($total_categories) + 1); ?>"><b
                                            class="white-text"><?php echo e(__($category_name)); ?></b></td>
                                    <?php $__currentLoopData = $total_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td class="hidden"> </td>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tr>
    ...
    <?php $__currentLoopData = $categories_names; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name_of_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <script>
            am4core.ready(function() {
                ...
                if("<?php echo e($name_of_category); ?>"== 'Categories_Sales_Percentages'){
                    console.log($('#<?php echo e($name_of_category); ?>_data').data('total'));
                }
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/client_view/reports/sales_gathering_analysis/categories_sales_report.blade.php ENDPATH**/ ?>