...
<?php endif; ?> 
                            ...
                            <div class="col-md-2">
                                <label><?php echo e(__('Select Currency')); ?> <span class="required">*</span></label>
                ...
                <div class="kt-portlet ">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row" style="flex:1;">
                            ...
                            <div class="col-lc-2">
                                <label >
								<?php echo __('Commission <br> Interval'); ?>

                                    <?php echo $__env->make('star', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </label>
                                <div class="input-group">
                                    <select name="termAndConditions[<?php echo e($index); ?>][commission_interval]" class="form-control repeater-select">
                                        ...
                                        <?php echo e(logger($name)); ?>

                                        <option value="<?php echo e($name); ?>" <?php if(isset($termAndCondition) && ($termAndCondition->getCommissionInterval() == $name ) ): ?> selected <?php elseif(!isset($termAndCondition) && $name == 'monthly'): ?> selected <?php endif; ?> > <?php echo e($nameFormatted); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
							   ...
							   <div class="col-2">
								...
								" value="<?php echo e((isset($termAndCondition) ? $termAndCondition->min_commission_fees : old('min_commission_fees',0))); ?>">
								   ...
								   <div class="col-2">
                                <label class="form-label font-weight-bold"><?php echo __('Admin <br> Fees Amount'); ?>
				  ...
				  <div class="kt-portlet ">
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            <div class="col-md-4 ">
                                 <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.input','data' => ['model' => $model??null,'label' => __('Financial Duration'),'type' => 'text','placeholder' => __('Financial Duration'),'name' => 'financial_duration','class' => 'only-greater-than-zero-allowed','required' => true]]); ?>
<?php $component->withName('form.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['model' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($model??null),'label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Financial Duration')),'type' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('text'),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Financial Duration')),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('financial_duration'),'class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('only-greater-than-zero-allowed'),'required' => true]); ?> <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\veroo\resources\views/reports/LetterOfCreditFacility/form.blade.php ENDPATH**/ ?>