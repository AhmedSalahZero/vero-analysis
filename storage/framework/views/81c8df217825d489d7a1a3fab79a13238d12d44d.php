    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="kt-form kt-form--label-right" method="POST"
                action=<?php if($name_of_selector_label == 'Sales Discount'): ?> <?php echo e(route('salesChannels.salesDiscount.analysis.result', $company)); ?>

                        <?php elseif($type == 'averagePrices' || ($type == 'averagePricesProductItems') ): ?> <?php echo e(route('averagePrices.result', $company)); ?>

                        <?php else: ?> <?php echo e(route('salesChannels.analysis.result', $company)); ?>
