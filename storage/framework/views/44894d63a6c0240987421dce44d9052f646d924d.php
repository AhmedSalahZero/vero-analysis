                    ...
                    <div class="kt-input-icon">
                        <div class="input-group date">
                            <select required name="down_payment_type" id="down_payment_type" class="form-control">
                                <option <?php if(isset($model) && $model->isDownPaymentOverContract() ): ?> selected <?php endif; ?> value="<?php echo e(MoneyPayment::DOWN_PAYMENT_OVER_CONTRACT); ?>"><?php echo e(__('Contract Down Payment')); ?></option>
                                <option <?php if(isset($model) && $model->isFreeDownPayment() ): ?> selected <?php endif; ?> value="<?php echo e(MoneyPayment::DOWN_PAYMENT_GENERAL); ?>"><?php echo e(__('General Down Payment')); ?></option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="kt-input-icon">
                            <div class="input-group date">
								...
								ajax-get-invoice-numbers
                                    ...
                                    <?php $__currentLoopData = Partner::getSuppliersForCompany($company->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplierId => $supplierName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?> 
    ...
    <?php if(isset($model) && $model->getDownPaymentType() != MoneyPayment::DOWN_PAYMENT_GENERAL ): ?>
