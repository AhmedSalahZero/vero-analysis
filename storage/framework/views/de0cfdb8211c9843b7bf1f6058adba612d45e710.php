...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('main-form-title'),'class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('')]); ?><?php echo e(__('Renewal Date')); ?> <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
    ...
    <div class="col-md-12">
        ...
        <div class="kt-portlet">
            ...
            <div class="kt-portlet__body">
                ...
                <?php if(isset($model) || $timeOfDeposit->isExpired()): ?>
                <div class="row">
                    <div class="col-md-12">
                        <!--begin::Portlet-->
                        ...
                        <!--begin::Form-->
                        <form method="post" action="<?php echo e(isset($model) ? route('update.time.of.deposit.renewal.date',['company'=>$company->id, 'timeOfDeposit'=>$timeOfDeposit->id , 'TdRenewalDateHistory'=>$model->id]) :route('store.time.of.deposit.renewal.date',['company'=>$company->id , 'timeOfDeposit'=>$timeOfDeposit->id])); ?>" class="kt-form kt-form--label-right">
                            <?php echo csrf_field(); ?>
                            <?php if(isset($model)): ?>
                                ...
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title head-title text-primary">
                                            <?php echo e(__('Adjusted Renewal Date Section')); ?>
                                ...
                                <div class="kt-portlet__body">
                                    <div class="form-group row">
                                        <div class="col-md-4 mb-4">
                                            <label> <?php echo e(__('Financial Institution')); ?> </label>
                                            <input type="text" class="form-control" disabled value="<?php echo e($timeOfDeposit->getFinancialInstitutionName()); ?>">
                                        </div>
                                        <div class="col-md-2 mb-4">
                                            <label><?php echo e(__('Account Number')); ?> </label>
                                            <input type="text" class="form-control" disabled value="<?php echo e($timeOfDeposit->getAccountNumber()); ?>">
                                        </div>
                                        <div class="col-md-1 mb-4">
                                            <label><?php echo e(__('Currency')); ?> </label>
                                            <input type="text" class="form-control" disabled value="<?php echo e($timeOfDeposit->getCurrency()); ?>">
                                        </div>
										
										     <div class="col-md-1 mb-4">
                                            <label><?php echo e(__('Interest Rate')); ?> </label>
                                            <input type="text" class="form-control" disabled value="<?php echo e($timeOfDeposit->getInterestRateFormatted()); ?>">
                                        </div>
										
										  <div class="col-md-2 mb-4">
                                            <label><?php echo e(__('Interest Amount')); ?> </label>
                                            <input type="text" class="form-control" disabled value="<?php echo e($timeOfDeposit->getInterestAmountFormatted()); ?>">
                                        </div>
										
                                        <div class="col-md-2 mb-4">
                                            <label><?php echo e(__('Expiry Date')); ?> </label>
											<input type="hidden" name="expiry_date" value="<?php echo e(isset($model)  ? $timeOfDeposit->getRenewalDateBefore($timeOfDeposit->getRenewalDate()) :$timeOfDeposit->getRenewalDate()); ?>">
                                            <input type="text" class="form-control" disabled  value="<?php echo e(isset($model)  ? $timeOfDeposit->getRenewalDateBefore($timeOfDeposit->getRenewalDate()) :$timeOfDeposit->getRenewalDate()); ?>">
                                        </div>
										 ...
										 <div class="col-md-1 mb-4">
                                            <label><?php echo e(__('Interest Rate')); ?> % </label>
                                            <input type="text" class="form-control" name="interest_rate" value="<?php echo e(isset($model)  ? $model->getInterestRate() : $timeOfDeposit->getInterestRate()); ?>">
                                        </div>
										  ...
										  <div class="col-md-2">
                                            ...
                                            <div class="kt-input-icon">
                                                <div class="input-group date">
                                                    <input required readonly type="text" name="renewal_date" value="<?php echo e(isset($model) ? $model->getRenewalDateFormattedForDatePicker() : null); ?>" id="kt_datepicker_2" class="form-control"   />
                                        ...
                                        <tbody>
                                            ...
                                            <tr class=" parent-tr reset-table-width text-nowrap  cursor-pointer sub-text-bg text-capitalize is-close   ">
                                                ...
                                                <td class="sub-text-bg  text-center max-w-action   ">
                                                    <?php if($loop->last): ?>
                                                    <a type="button" class="btn btn-secondary btn-outline-hover-brand btn-icon" title="Edit" href="<?php echo e(route('edit.time.of.deposit.renewal.date',[$company,$timeOfDeposit->id,$renewalDateHistory->id])); ?>"><i class="fa fa-pen-alt"></i></a>
                                                    ...
                                                    <div id="modal-delete-<?php echo e($renewalDateHistory['id']); ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="<?php echo e(route('delete.time.of.deposit.renewal.date',[$company,$timeOfDeposit->id,$renewalDateHistory->id])); ?>" method="post" id="delete_form">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salah/Software/projects/veroo/resources/views/reports/time-of-deposit/renewal-date/index.blade.php ENDPATH**/ ?>