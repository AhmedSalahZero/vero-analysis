...
<ul class="kt-menu__nav ">
    <li class="kt-menu__item  kt-menu__item" aria-haspopup="true"><a href="<?php echo e(route('forecast.report',$company)); ?>" class="kt-menu__link "><span class="kt-menu__link-text"><?php echo e(__('Sales Target Dashboard')); ?></span></a></li>
    <li class="kt-menu__item  kt-menu__item " aria-haspopup="true"><a href="<?php echo e(route('breakdown.forecast.report',$company)); ?>" class="kt-menu__link active-button"><span class="kt-menu__link-text active-text"><?php echo e(__("Target Breakdown Dashboard")); ?></span></a></li>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        ...
        <?php $__currentLoopData = $reports_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $report_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-<?php echo e($count == 1 ? 12 : 6); ?>">
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title head-title text-primary">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/client_view/forecast_summary_reports/breakdown_dashboard.blade.php ENDPATH**/ ?>