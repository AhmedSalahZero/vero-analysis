    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-toolbar justify-content-between flex-grow-1">
            <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(!Request('active') || Request('active') == 'fully-secured-over-draft' ?'active':''); ?>" data-toggle="tab" href="#fully-secured-over-draft" role="tab">
                        <i class="fa fa-money-check-alt"></i> <?php echo e(__('Fully Secured Overdraft Table')); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\veroo\resources\views/reports/fully-secured-overdraft/index.blade.php ENDPATH**/ ?>