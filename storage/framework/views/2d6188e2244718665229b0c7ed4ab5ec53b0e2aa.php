                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo csrf_field(); ?>
                            <form action="<?php echo e(route('view.letter.of.guarantee.facility',['company'=>$company->id,'financialInstitution'=>$financialInstitution->id])); ?>"  class="row ">
...
<?php /**PATH /media/salah/Software/projects/veroo/resources/views/components/export-letter-of-guarantee-facility.blade.php ENDPATH**/ ?>