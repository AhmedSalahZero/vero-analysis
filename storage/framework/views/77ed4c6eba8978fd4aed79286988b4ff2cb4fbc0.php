                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date">
                                    <select required name="report_type" class="form-control update-lc-or-lg-type">
                                        ...
                                        <?php $__currentLoopData = ['LetterOfCreditIssuance'=>__('Letter Of Credit Bank Statement') , 'LetterOfGuaranteeIssuance'=>__('Letter Of Guarantee Bank Statement')]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tableName => $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
