                ...
                <div style="flex-wrap:nowrap;" <?php if($isRepeater): ?> data-repeater-item <?php endif; ?> class="form-group date-element-parent m-form__group row align-items-center 
                    ...
                    <div class="col-2">
                        ...
                        <div class="kt-input-icon">
                            <div class="input-group">
                                <input type="text" class="form-control only-numeric-allowed trigger-change-repeater" value="<?php echo e(number_format(isset($account) ? $account->getBalanceAmount() : old('balance_amount',0))); ?>">
