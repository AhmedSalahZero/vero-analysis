 ...
 <a data-toggle="modal" data-target="#review-id-<?php echo e($model->id); ?>" type="button" class="btn btn-secondary btn-outline-hover-success btn-icon" title="<?php echo e(__('Reviewed')); ?>" href="#"><i class="fa fa-key"></i></a>
