                                ...
                                <div class="kt-portlet__body kt-portlet__body--fluid">
                                    <div class="kt-widget12">
                                        <div class="kt-widget12__chart">
                                            <!-- HTML -->
                                            <h4><?php echo e(str_replace('_', ' ', $name_of_zone) . ($name_of_zone ==  "Branch_Sales_Percentages" ? ' Against Total Sales' : ' Sales Trend Analysis Chart')); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Table::class, ['tableTitle' => __('Products Items Sales Trend Analysis Report'),'tableClass' => 'kt_table_with_no_pagination_no_search']); ?>
...
<?php $component->withAttributes([]); ?>
                        <?php $__env->slot('table_header'); ?>
                            <tr class="table-active">
                                <th><?php echo e(__('Product Item')); ?></th>
                       ...
                       <td class="text-center"> 
                            ...
                            <tr>
                                ...
                                <?php $__currentLoopData = $total_branches_growth_rates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    $chart_data[] = [
                                        'date' => date('d-M-Y', strtotime($date)),
...
<?php $component->withAttributes([]); ?>
                        ...
                        <?php $__env->slot('table_body'); ?>
                            ...
                            ?>
                            <input type="hidden" id="Branch_Sales_Percentages_data" data-total="<?php echo e(json_encode($return)); ?>">


                            <tr>
                                <th class="active-style text-center"><?php echo e(__('TOTAL %')); ?></th>
                                <?php $__currentLoopData = $total_branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td class="text-center active-style"> <?php echo e($sumOfTotalsOfBranchSales && $total ? number_format(   ($total / $sumOfTotalsOfBranchSales)*100  ,  2) : 0); ?> % </td>
    ...
    <?php $__currentLoopData = $branches_names; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name_of_zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <script>
            am4core.ready(function() {
                ...
                if("<?php echo e($name_of_zone); ?>"== 'Branch_Sales_Percentages'){
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VeroAnalysis\resources\views/client_view/reports/sales_gathering_analysis/products_items_sales_report.blade.php ENDPATH**/ ?>