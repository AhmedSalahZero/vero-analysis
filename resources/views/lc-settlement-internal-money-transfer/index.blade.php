...
<div class="kt-portlet kt-portlet--tabs">
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-toolbar justify-content-between flex-grow-1">
            ...
            <div class="flex-tabs">
                {{-- <a href="{{ route('lc-settlement-internal-money-transfers.create',['company'=>$company->id,LcSettlementInternalMoneyTransfer::BANK_TO_BANK]) }}" class="btn active-style btn-icon-sm align-self-center">
                <i class="fas fa-plus"></i>
                {{ __('Bank To Bank') }}
                </a>


                <a href="{{ route('lc-settlement-internal-money-transfers.create',['company'=>$company->id,LcSettlementInternalMoneyTransfer::SAFE_TO_BANK]) }}" class="btn  active-style btn-icon-sm align-self-center">
                    <i class="fas fa-plus"></i>
                    {{ __('Safe To Bank') }}
                </a> --}}
