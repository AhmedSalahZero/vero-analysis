...
<div class="row">
    <div class="col-md-12">
        ...
        <form method="post" action="{{ isset($model) ?  route('internal-money-transfers.update',['company'=>$company->id,'internal_money_transfer'=>$model->id]) :route('internal-money-transfers.store',['company'=>$company->id]) }}" class="kt-form kt-form--label-right">
                        ...
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title head-title text-primary">
                                    <x-sectionTitle :title="__((isset($model) ? 'Edit' : 'Add') . ' Internal Money Transfer')"></x-sectionTitle>
                                </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="kt-portlet">
                            ...
                            <div class="kt-portlet ">
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title head-title text-primary">
                                            {{__('Internal Money Transfer Information')}}
                                        </h3>
                                    </div>
                                </div>
