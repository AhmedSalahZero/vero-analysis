...
<div class="kt-portlet kt-portlet--tabs">
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-toolbar justify-content-between flex-grow-1">
            <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
                <li class="nav-item">
                    <a class="nav-link {{ !Request('active') || Request('active') == 'internal-money-transfer' ?'active':'' }}" data-toggle="tab" href="#internal-money-transfer" role="tab">
                        <i class="fa fa-money-check-alt"></i> {{ __('Internal Money Transfer Table') }}
                    </a>
                </li>
    ...
    <div class="kt-portlet__body">
        <div class="tab-content  kt-margin-t-20">
            ...
            <!--Begin:: Tab Content-->
            <div class="tab-pane {{ !Request('active') || Request('active') == 'internal-money-transfer' ?'active':'' }}" id="bank" role="tabpanel">
                    ...
                    <div class="kt-portlet__head kt-portlet__head--lg p-0">
                        <div class="kt-portlet__head-label">
                            ...
                            <h3 class="kt-portlet__head-title">
                                {{ __('Internal Money Transfer Table') }}
                            </h3>
                        </div>
                        {{-- Export --}}
