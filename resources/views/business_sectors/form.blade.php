...
<div class="row">
    <div class="col-md-12">
        ...
        <form method="post" action="{{ isset($model) ?  route($updateRouteName,['company'=>$company->id,'businessSector'=>$model->id]) :route($storeRouteName,['company'=>$company->id]) }}" class="kt-form kt-form--label-right">
