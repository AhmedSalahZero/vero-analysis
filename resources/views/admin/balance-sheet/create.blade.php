...
@endsection
@section('sub-header')
<x-main-form-title :id="'main-form-title'" :class="''">{{ __('Balance Sheet') }}</x-main-form-title>
@endsection
@section('content')
<div class="row">
    <div class="col-md-12">

        <form id="form-id" class="kt-form kt-form--label-right" method="POST" enctype="multipart/form-data" action="{{  isset($disabled) && $disabled ? '#' : (isset($model) ? route('admin.update.balance.sheet',[$company->id , $model->id]) : $storeRoute)  }}">
            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">
                    ...
                    <h2 for="" class="d-bloxk mb-4">{{ __('Balance Sheet Information') }}</h2>
