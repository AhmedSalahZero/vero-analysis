...
<div class="table-custom-container position-relative  ">
    ...
    <x-tables.basic-view class="position-relative  main-table-class" id="{{ $tableId }}">
        <x-slot name="filter">
            @include('admin.balance-sheet.filter' , [
            'type'=>'filter'
            ])
        </x-slot>

        <x-slot name="export">
            @include('admin.balance-sheet.export' , [
            'type'=>'export'
            ])
        </x-slot>
            ...
            <script>
                window.addEventListener('DOMContentLoaded', function() {
                    (function() {
                        ...
                        <a href="/` + $('body').data('lang') + '/' + $('body').data('current-company-id') + `/balance-sheet/${row.id}/report"  data-id="${row.id}" data-model-name="{{$modelName}}" class="btn btn-sm cursor-pointer btn-clean btn-icon btn-icon-md" title="{{ __('Edit Balance Sheet Report') }}">
                          <i class="la la-money icon-lg"></i>
                        </a>

                          

                        <a dat{{ a-model-name=" }}{{$modelName}}" data-table-id="${tableId.replace('#','')}" data-record-id="${row.id}"   class="btn btn-sm btn-clean delete-record-btn btn-icon btn-icon-md" title="{{ __('Delete') }}">
