...
<form class="kt-form kt-form--label-right" id="create-form" method="POST" action="{{ route('loan2.store.php',['company' => $company->id,'financialInstitution'=>$financialInstitution->id]) }}">
    {{ csrf_field() }}
                        ...
                        <label class="col-form-label take">{{__('Loan Start Date')}}
						   ...
						   {{-- <div class="kt-input-icon">
                                <div class="input-group date">
                                    <input type="text" name="study_start_date" class="only-month-year-picker date-input form-control recalc-study-end-date study-start-date recalate-development-start-date recalate-operation-start-date" readonly value="{{ isset($model) ? $model->getStudyStartDate() : getCurrentDateForFormDate('date') }}"  />
                ...
                <div class="col-md-4 item-main-parent" style="display: none">
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            ...
                            type="text" step="any" id="grace_periodid" name="grace_period" class="form-control number grace_period_calc installment_condition" placeholder="{{__('Grace Period')}} .." />
