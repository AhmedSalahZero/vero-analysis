        ...
        <div class="kt-portlet__body">
			...
			<div class="col-md-3 item-main-parent">
                    <div class="form-group validated">
                        <label class="col-form-label take">{{__('Loan Nature')}}</label><span class="astric">*</span>
                        <div class="form-group-sub">
						
                            <select name="nature_type" id="nature_type" class="form-control">
                                @foreach(['variable_at_end'=>__('Variable At End') ,'variable_at_beginning'=>__('Variable At Beginning')] as $natureType => $natureTitle)
                                <option value="{{ $natureType }}" {{ isset($currentNatureType) && $currentNatureType == $natureType ? 'selected' : '' }} >{{$natureTitle}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            <select name="fixed_loan_type" id="fixed_loan_type" class="form-control">
                                ...
                                <option value="{{ $fixedType }}" {{ @old('fixed_loan_type') == $fixedType ? 'selected' : '' }} {{ isset($loan) && ($loan->fixedType == $fixedType) ? 'selected' : ''  }}>{{str_to_upper($fixedType)}}</option>
                                @endforeach
                            </select>
                            @if ($errors->has('installment_interval'))
                            <div class="invalid-feedback">{{ $errors->first('fixed_loan_type') }}</div>
                ...
                <div class="col-md-3 item-main-parent">
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            <input  value="{{ $loan && $loan->start_date ?$loan->start_date:null  }}"  required type="date" id="start-date" name="start_date" class="form-control number interval-calcs" placeholder="{{__('Loan Start Date')}} {{__('Autoload')}}  .." />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 item-main-parent">
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            <input @if($loan && $loan->margin_rate)
                ...
                <div class="col-md-4 item-main-parent" style="display: none">
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            <input @if($loan && $loan->grace_period)
                    ...
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            <select disabled name="capitalization_type" id="capitalization_type" class="form-control">
								...
								{{ $loan && $loan->is_with_capitalization ? 'selected' : '' }}
                    ...
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            <select name="installment_interval" id="installment_interval" class="form-control installment_condition">
                                ...
                                <option @if($loan && $loan->installment_interval == 'monthly')
                                    selected
   ...
   <div class="col-md-4 item-main-parent">
                ...
                <div class="col-md-4 item-main-parent" style="display: none">
                    <div class="form-group validated">
                        ...
                        <div class="" id="step-up-id">
                            <div class="form-group-sub">
                                <input @if($loan && $loan->step_up_rate)
                    ...
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            <select name="step_up_interval" id="step_up_interval" class="form-control interval-calcs">
                                ...
                                <option @if($loan && $loan->step_up_interval == 'annually')
                                    selected
                ...
                <div class="col-md-4 item-main-parent" style="display: none">
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            <input @if($loan && $loan->step_down_rate)
                            ...
                            step="any"  id="step_down_rate" name="step_down_rate" value="{{ @old('step_down_rate') }}" class="form-control negative-numbers" placeholder="{{__('Step-down Rate')}} .." required />
                    ...
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            <select name="step_down_interval" id="step_down_interval" class="form-control interval-calcs">
                                ...
                                <option @if($loan && $loan->step_down_interval == 'annually')
                                    selected
...
<table class='table table-striped table-bordered table-hover table-checkable' id="dynamic-datatable">
	<thead>
		   <th class="text-center font-weight-bold">{{__("Payment No.")}}</th>
                            ...
                            <th class="text-center font-weight-bold">{{__("Beginning Balance")}}</th>
                            <th class="text-center font-weight-bold">{{__("Interest Amount")}}</th>
                            <th class="text-center font-weight-bold">{{__("Schedule Payment")}}</th>
                            <th class="text-center font-weight-bold">{{__("Interest Payment")}}</th>
                            <th class="text-center font-weight-bold">{{__("Principle Payment")}}</th>
                            <th class="text-center font-weight-bold">{{__("End Balance")}}</th>
	...
	@endphp
		...
		<tr>
			...
			<td class="text-center">{{ number_format($result['beginning'][$date] ?? 0) }}</td>
			<td class="text-center">{{ number_format($result['interestAmount'][$date] ?? 0) }}</td>
			<td class="text-center">{{ number_format($result['schedulePayment'][$date] ?? 0) }}</td>
			<td class="text-center">{{ number_format($result['interestPayment'][$date] ?? 0) }}</td>
			<td class="text-center">{{ number_format($result['principleAmount'][$date] ?? 0) }}</td>
			<td class="text-center">{{ number_format($result['endBalance'][$date] ?? 0) }}</td>
		</tr>
		@php
			$index++;
		@endphp
		...
		<tr class="custom-color-for-last-tr">
			...
			<th class="text-center"> {{ number_format($result['totals']['totalSchedulePayment'] ?? 0) }} </th>
			<th class="text-center"> {{ number_format($result['totals']['totalInterestAmount'] ?? 0) }} </th>
			<th class="text-center"> {{ number_format($result['totals']['totalPrincipleAmount'] ?? 0 )}} </th>
					<th>-</th>
