...
<i class="la la-money icon-lg"></i>
                        ...
                        <a href="/` + $('body').data('lang') + '/' + $('body').data('current-company-id') + `/balance-sheet/${row.financial_statement_able_id}/report"  data-id="${row.financial_statement_able_id}" data-model-name="{{$modelName}}" class="btn btn-sm cursor-pointer btn-clean btn-icon btn-icon-md" title="{{ __('Edit Balance Sheet Report') }}">
                          <i class="la la-money icon-lg"></i>
                        </a>
                        ...
                        <a href="/` + $('body').data('lang') + '/' + $('body').data('current-company-id') + `/financial-statement/${row.id}/report"  data-id="${row.id}" data-model-name="{{$modelName}}" class="btn btn-sm cursor-pointer btn-clean btn-icon btn-icon-md" title="{{ __('Edit Financial Statement Report') }}">
                          <i class="la la-money icon-lg"></i>
                        </a>
