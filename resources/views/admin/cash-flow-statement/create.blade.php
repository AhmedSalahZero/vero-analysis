...
@endsection
@section('sub-header')
<x-main-form-title :id="'main-form-title'" :class="''">{{ __('Cash Flow Statement') }}</x-main-form-title>
@endsection
@section('content')
<div class="row">
    <div class="col-md-12">

        <form id="form-id" class="kt-form kt-form--label-right" method="POST"  enctype="multipart/form-data"  action="{{  isset($disabled) && $disabled ? '#' : (isset($model) ? route('admin.update.cash.flow.statment',[$company->id , $model->id]) : $storeRoute)  }}" >
        ...
        @csrf
            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">
                            ...
                            <h2 for="" class="d-bloxk mb-4">{{ __('Cash Flow Statement Information') }}</h2>
