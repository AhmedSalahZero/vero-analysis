...
<div class="row">
    <div class="col-md-12">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="POST" action="{{ route('result.collections.effectiveness.index',['company'=>$company->id  ]) }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="kt-portlet__body">
					...
					<div class="col-md-3 mb-4">
					 ...
					 <div class="col-md-3 mb-4">
                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date" >
                                    <input type="date" class="form-control" name="start_date" value="{{ $defaultStartDate }}">
                                </div>
                            </div>
                        </div>
					 ...
					 <div class="col-md-3 mb-4">
                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date" >
                                    <input type="date" class="form-control" name="end_date" value="{{$defaultEndDate}}">
                                </div>
                            </div>
                        </div>
