    ...
    <div class="col-md-12">
        ...
        <div class="kt-portlet">
            ...
            <div class="kt-portlet__body" style="overflow:hidden !important;">
                ...
                <form method="post" action="{{ route('add.count.dynamic.items',['company'=>$company->id]) }}" class="row">
                    @csrf
                    <div class="col-md-5">
                    ...
                    <div class="col-md-3 text-center">
                        <div class="form-group text-center">
                            <label class="label">{{ __('Has Sub Items') }}</label>
                    ...
                    <div class="col-md-2 d-none how-many-div-js">
                        <div class="form-group">
					  ...
					  <div class="col-md-3">
                        <div class="form-group">
                            <label class="label">{{ __('Sub Item ['. ($i+1) .'] Name') }}</label>
                            <input value="{{ $subItemsNames[$i]??''  }}" type="text" name="sub_items_names[]" class="form-control">
                        </div>
            </div>
            @endfor
                    <div class="col-md-3" style="align-items:flex-end;display:flex;">
                        <div class="form-group">
...
@if($subItemsCount['how_many_items']??0 )
    <form id="form-id" class="kt-form kt-form--label-right" method="POST" enctype="multipart/form-data" action="#">
        @csrf
            ...
            <div class="kt-portlet__body">
                ...
                <div class="form-group row justify-content-center">
                    ...
                    <x-tables.repeater-table :repeater-with-select2="true" :parentClass="'js-toggle-visiability'" :tableName="$tableId" :repeaterId="$repeaterId" :relationName="'food'" :isRepeater="$isRepeater=!(isset($removeRepeater) && $removeRepeater)">
                        <x-slot name="ths">
                            {{-- <x-tables.repeater-table-th colspan="3" class="col-md-2" :title="'main field'"></x-tables.repeater-table-th>
                            <x-tables.repeater-table-th colspan="3" class="col-md-2" :title="'sub field 1'"></x-tables.repeater-table-th>
                            <x-tables.repeater-table-th colspan="3" class="col-md-2" :title="'sub field 2'"></x-tables.repeater-table-th>
                        ...
                        <x-slot name="trs">
                            ...
                            <tr @if($isRepeater) data-repeater-item @endif>
                                ...
                                <input type="hidden" name="id" value="1">
                                    <x-form.select-with-modal-abb :add-new-modal="true" class="text-center repeater-select" :add-new-modal-modal-type="''" :add-new-modal-modal-name="'RevenueBusinessLine'" :add-new-modal-modal-title="__('Governate')" :options="[]" :add-new="false" :label="__('Governate')" class="select2-select revenue_business_line_class  " data-filter-type="{{ __('create') }}" :all="false" name="revenue_business_line_id" id="{{'revenue_business_line_id' }}" :selected-value="1"></x-form.select-with-modal-abb>

                                    </td>

                                    <td>
                                        <label class="form-label font-weight-bold">Abb</label>
                                        <input type="text" value="{{ 1 }}" class="form-control max-w-150" @if($isRepeater) name="{{ 'name' }}" @else name="{{ $tableId }}[0][{{ 'name' }}]" @endif>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <label class="form-label font-weight-bold">Code</label>
                                        <input type="text" value="{{ 1 }}" class="form-control max-w-150" @if($isRepeater) name="{{ 'code' }}" @else name="{{ $tableId }}[0][{{ 'code' }}]" @endif>
                                    </td>
									@endforeach  --}}
