                                ...
                                <tr>
                                    ...
                                    <td class="kt-datatable__cell--left kt-datatable__cell " data-field="Actions" data-autohide-disabled="false">
                                        <span style="overflow: visible; position: relative; width: 110px;">
											@if(hasAuthFor('update employees'))
                                            <a type="button" class="btn btn-secondary btn-outline-hover-brand btn-icon" title="Edit" href="{{ route('employees.edit',['company'=>$company->id,'employee'=>$model->id]) }}"><i class="fa fa-pen-alt"></i></a>
											@endif 
											{{-- @if(hasAuthFor('delete employees'))
                                            <a data-toggle="modal" data-target="#delete-employee-{{ $model->id }}" type="button" class="btn btn-secondary btn-outline-hover-danger btn-icon" title="Delete" href="#"><i class="fa fa-trash-alt"></i></a>
                                            <div class="modal fade" id="delete-employee-{{ $model->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <form action="{{ route('employees.destroy',['company'=>$company->id,'employee'=>$model->id ]) }}" method="post">
                                                            @csrf
                                                            @method('delete')
