...
<div class="row">
    <div class="col-md-12">
        ...
        <form method="post" action="{{ isset($model) ?  route($updateRouteName,['company'=>$company->id,'salesChannel'=>$model->id]) :route($storeRouteName,['company'=>$company->id]) }}" class="kt-form kt-form--label-right">
                        ...
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title head-title text-primary">
                                    <x-sectionTitle :title="__((isset($model) ? 'Edit' : 'Add') . ' Sales Channel')"></x-sectionTitle>
                                </h3>
                            </div>
                        </div>
                    </div>
