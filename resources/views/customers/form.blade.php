...
<div class="row">
    <div class="col-md-12">
        ...
        <form method="post" action="{{ isset($model) ?  route('customers.update',['company'=>$company->id,'customer'=>$model->id]) :route('customers.store',['company'=>$company->id]) }}" class="kt-form kt-form--label-right">
