                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title head-title text-primary">
                            <x-sectionTitle :title="__((isset($model) ? 'Edit' : 'Add') . ' Fully Secured Overdraft')"></x-sectionTitle>
                        </h3>
                    </div>
                </div>
            </div>
            ...
            <form class="kt-form kt-form--label-right">
				 ...
				 <div class="kt-portlet">
                            ...
                            <div class="kt-portlet__body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2 ">
                                        <x-form.input :id="'cd-or-td-amount-id'" :readonly="true" :default-value="0" :model="$model??null" :label="__('Amount')" :type="'text'" :placeholder="''" :name="'cd_or_td_amount'" :class="''" :required="true"></x-form.input>
                                    </div>
									 ...
									 <div class="col-md-2 ">
                                        <x-form.input :id="'cd-or-td-interest-rate-id'" :readonly="true" :default-value="0" :model="$model??null" :label="__('CD Or TD Interest Rate')" :type="'text'" :placeholder="''" :name="'cd_or_td_interest'" :class="''" :required="true"></x-form.input>
										 ...
										 <div class="col-md-2 ">
                                        <x-form.input :id="'cd-or-td-lending-percentage-id'" :readonly="false" :default-value="0" :model="$model??null" :label="__('CD Or TD Lending Percentage')" :type="'text'" :placeholder="''" :name="'cd_or_td_lending_percentage'" :class="'only-percentage-allowed'" :required="true"></x-form.input>
                                    </div>
                ...
                <div class="kt-portlet ">
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            <div class="col-md-4 ">
                                <x-form.input :readonly="true" :model="$model??null" :label="__('Limit')" :type="'text'" :placeholder="__('Limit')" :name="'limit'" :class="'only-greater-than-zero-allowed'" :required="true"></x-form.input>
                            </div>
                            ...
                            <div class="col-md-4 ">
                                <x-form.input :readonly="true" :model="$model??null" :class="'only-percentage-allowed'" :label="__('Borrowing Rate (%)')" :type="'text'" :placeholder="__('Borrowing Rate (%)')" :name="'borrowing_rate'" :required="true"></x-form.input>
                            </div>
