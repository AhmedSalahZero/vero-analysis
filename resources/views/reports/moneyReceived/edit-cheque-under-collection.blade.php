                ...
                <div class="col-md-3">
                    ...
                    <div class="kt-input-icon">
                        <div class="input-group date">
                            <input required  value="{{ $model->getChequeDepositDateFormattedForDatePicker() }}" type="text" name="cheque_deposit_date" class="form-control" readonly placeholder="Select date" id="kt_datepicker_2" />
