            ...
            <div class="tab-pane {{ !Request('active') || Request('active') == 'over-draft-against-commercial-paper' ?'active':'' }}" id="bank" role="tabpanel">
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__head kt-portlet__head--lg p-0">
                        ...
                        {{-- Export --}}
                        <x-export-overdraft-against-commercial-paper :search-fields="$searchFields" :money-received-type="'bank'" :has-search="1" :has-batch-collection="0"   href="{{route('create.overdraft.against.commercial.paper',['company'=>$company->id,'financialInstitution'=>$financialInstitution->id])}}" />
                    </div>
                    <div class="kt-portlet__body">
                        ...
                        <table class="table  table-striped- table-bordered table-hover table-checkable text-center kt_table_1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $overdraftAgainstCommercialPaper->getCurrency() }}</td>
