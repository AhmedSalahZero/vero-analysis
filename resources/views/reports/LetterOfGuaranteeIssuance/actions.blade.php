                                     ...
                                     <tbody>
                                         ...
                                         <tr>
                                             ...
                                             <td>
                                                 ...
                                                 <div class="modal fade" id="edit-advanced-payment-lg-{{ $advancedPaymentHistory->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                     <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                                         <div class="modal-content">
                                                 ...
                                                 <div class="modal fade" id="delete-advanced-payment-lg-{{ $advancedPaymentHistory->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
 ...
 @endif
 <a data-toggle="modal" data-target="#cancel-deposit-modal-{{ $model->id }}" type="button" class="btn  btn-secondary btn-outline-hover-success   btn-icon" title="{{ __('Cancel Letter') }}" href="#"><i class="fa fa fa-ban"></i></a>
