                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            @csrf
                            <form action="{{ route('odoo-expenses.index',['company'=>$company->id ]) }}"  class="row ">
                        ...
                        <div class="modal-footer">
                            <button type="submit" href="{{ route('odoo-expenses.index',['company'=>$company->id]) }}" id="js-search-id" type="submit" id="" class="btn btn-primary">{{ __('Search') }}</button>
                        </div>
