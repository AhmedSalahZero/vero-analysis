 ...
 <div  id="m_repeater_{{ $instanceNo }}"  {{ $attributes->merge(['class'=>'d-block w-full repeater-class']) }}>
                                <div class="form-group w-100 m-form__group row d-inline-flex" >
                                    <div
                                     ...
                                     data-repeater-list="{{ $groupName }}" class="col-lg-12 d-flex flex-wrap  align-items-center mx-auto">
                                        <div 
                                       @if($repeaterWithSelect2)
                                        style="display: none; !important"
                                        @endif
                                         data-repeater-item class="form-group m-form__group row align-items-center repeater_item {{ $itemClasses ? $itemClasses : 'w-48' }}">
                                            ...
                                            <div class="">
                                                <i data-repeater-delete=""
                                                    class="btn-sm btn btn-danger m-btn m-btn--icon m-btn--pill trash_icon fas fa-times-circle">
  ...
  <div class="m-form__group form-group row">
                                    ...
                                    <div class="col-lg-6">
                                            <div data-repeater-create=""
                                                class="btn btn btn-sm btn-success m-btn m-btn--icon m-btn--pill m-btn--wide {{__('right')}}" id="add-row">
                                                <span>
