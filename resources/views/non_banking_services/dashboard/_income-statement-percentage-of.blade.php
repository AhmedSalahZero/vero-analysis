        ...
        @endforeach
                                ...
                                <x-slot name="trs">
                                    ...
                                    <tr data-repeat-formatting-decimals="1" data-repeater-style>
                                        ...
                                        <td>
                                            <div class="max-250-w">
                                                <input value="{{ __('Revenues Growth Rate %') }}" disabled class="form-control  text-left " type="text">
                                            </div>
                                    ...
                                    <tr data-repeat-formatting-decimals="1" data-repeater-style>
                                        ...
                                        <td>
                                            <div class="max-250-w">
                                                <input value="{{ __('Gross Profit % / REV.') }}" disabled class="form-control  text-left " type="text">
                                            </div>
                                    ...
                                    <tr data-repeat-formatting-decimals="1" data-repeater-style>
                                        ...
                                        <td>
                                            <div class="max-250-w">
                                                <input value="{{ __('EBITDA % / REV.') }}" disabled class="form-control  text-left " type="text">
                                            </div>
                                    ...
                                    <tr data-repeat-formatting-decimals="1" data-repeater-style>
                                        ...
                                        <td>
                                            <div class="max-250-w">
                                                <input value="{{ __('EBIT % / REV.') }}" disabled class="form-control  text-left " type="text">
                                            </div>
                                    ...
                                    <tr data-repeat-formatting-decimals="1" data-repeater-style>
                                        ...
                                        <td>
                                            <div class="max-250-w">
                                                <input value="{{ __('EBT % / REV.') }}" disabled class="form-control  text-left " type="text">
                                            </div>
                                    ...
                                    <tr data-repeat-formatting-decimals="1" data-repeater-style>
                                        ...
                                        <td>
                                            <div class="max-250-w">
                                                <input value="{{ __('Net Profit % / REV.') }}" disabled class="form-control  text-left " type="text">
                                            </div>
