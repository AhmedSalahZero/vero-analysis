                            ...
                            <div class="form-group row justify-content-center">
                                ...
                                <x-tables.repeater-table :hideByDefault="false" :removeRepeater="false" :repeater-with-select2="true" :parentClass="' js-toggle-visibility'" :tableName="$tableId" :repeaterId="$repeaterId" :relationName="'food'" :isRepeater="$isRepeater=!(isset($removeRepeater) && $removeRepeater)">
                                    <x-slot name="ths">
                                        ...
                                        <x-tables.repeater-table-th class="col-md-2 header-border-down" :title="__('Discount <br> Rate')" :helperTitle="__('Default date is Income Statement start date, if else please select a date')"></x-tables.repeater-table-th>
                            ...
                            <table class="table table-white repeater-class repeater ">
                                ...
                                <tbody>
                                    ...
                                    <tr data-repeat-formatting-decimals="0" data-repeater-style>
                                        ...
                                        <td class="td-classes">
                                            <div>
                                                <input value="{{ number_format($securitizationCalculation['portfolio_disbursement_amount']) }}" disabled="" class="form-control " type="text">
                                            </div>
