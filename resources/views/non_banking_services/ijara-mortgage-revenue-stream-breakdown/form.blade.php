            ...
            <div class="kt-portlet">
                <div class="kt-portlet__body">
                    <div class="row">
                        ...
                        <div class="col-md-2 text-right">
                            <x-show-hide-btn :query="'.ijara-break-fees'"></x-show-hide-btn>
                    ...
                    <div class="row ijara-break-fees">
                        @php
                        $rowIndex = 0;
                        ...
                        <x-tables.repeater-table :tableName="$relationName" :repeaterId="$repeaterId" :removeActionBtn="false" :removeRepeater="false" :initialJs="true" :repeater-with-select2="true" :canAddNewItem="true" :parentClass="'js-remove-hidden overflow-scroll'" :hide-add-btn="true" :relationName="$relationName" :isRepeater="true">
                            ...
                            <x-slot name="trs">
                                ...
                                <tr data-repeater-item data-repeat-formatting-decimals="0" data-repeater-style total-row-tr data-row-total>
                                    ...
                                    <td>
                                        <x-repeat-right-dot-inputs number-format-decimals="0" :mark="'Mth'" :remove-three-dots="true" :currentVal="isset($subModel) ? $subModel->getTenor():12" :classes="'only-greater-than-zero-allowed exclude-from-total'" :is-percentage="true" :name="'tenor'" :columnIndex="null"></x-repeat-right-dot-inputs>

                                    </td>
                                    <td>
                                        <x-repeat-right-dot-inputs number-format-decimals="0" :mark="'Mth'" :remove-three-dots="true" :currentVal="isset($subModel) ? $subModel->getGracePeriod():0" :classes="'only-greater-than-or-equal-zero-allowed exclude-from-total'" :is-percentage="true" :name="'grace_period'" :columnIndex="null"></x-repeat-right-dot-inputs>
