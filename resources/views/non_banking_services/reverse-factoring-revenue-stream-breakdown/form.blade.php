                        ...
                        <x-tables.repeater-table :removeActionBtn="true" :removeRepeater="true" :initialJs="false" :repeater-with-select2="true" :canAddNewItem="false" :parentClass="'js-remove-hidden'" :hide-add-btn="true" :tableName="''" :repeaterId="''" :relationName="'food'" :isRepeater="$isRepeater=!(isset($removeRepeater) && $removeRepeater)">
                            ...
                            <x-slot name="trs">
                                ...
                                <tr data-repeat-formatting-decimals="2" data-repeater-style {{-- @if($isRepeater) data-repeater-item @endif --}}>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center justify-content-center">
                                            ...
                                            <x-repeat-right-dot-inputs :inputHiddenAttributes="'js-recalculate-equity-funding-value'" :currentVal="$model->reverseFactoringNewPortfolioFundingStructure ? $model->reverseFactoringNewPortfolioFundingStructure->getEquityFundingRatesAtYearOrMonthIndex($yearOrMonthAsIndex):0" :classes="'only-greater-than-or-equal-zero-allowed equity-funding-rates equity-funding-rate-input-hidden-class'" :is-percentage="true" :name="'reverseFactoringNewPortfolioFundingStructure['.'equity_funding_rates'.']['.$yearOrMonthAsIndex.']'" :columnIndex="$columnIndex"></x-repeat-right-dot-inputs>
                                ...
                                <tr data-repeat-formatting-decimals="2" data-repeater-style>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center justify-content-center">
                                            <input type="text" data-column-index="{{ $columnIndex }}" readonly class="form-control expandable-percentage-input new-loan-function-rates-js" name="reverseFactoringNewPortfolioFundingStructure[new_loans_funding_rates][{{ $yearOrMonthAsIndex }}]" value="{{ $model->reverseFactoringNewPortfolioFundingStructure ? $model->reverseFactoringNewPortfolioFundingStructure->getNewLoansFundingRatesAtYearOrMonthIndex($yearOrMonthAsIndex):0 }}"> <span class="ml-2">%</span>
                                        </div>
                                    </td>
                                    @php
                                    $columnIndex++;
