        ...
        <div class="form-group d-inline-block">
            <div class="kt-radio-inline">
                ...
                <label class="kt-radio kt-radio--success text-black font-size-18px font-weight-bold">
                    ...
                    <input class="is-fully-funded-checkbox exclude-from-trigger-change-when-repeat" type="radio" value="1" name="fixedAssetsFundingStructure[is_fully_funded_though_equity]" @if(!isset($subModel) || ($isFullyFundingTroughEquity)) checked @endisset
                    > {{ __('Fully Funded Through Equity') }}
                    <span></span>
                </label>

                <label class="kt-radio kt-radio--danger text-black font-size-18px font-weight-bold">
                    <input class="is-fully-funded-checkbox exclude-from-trigger-change-when-repeat" type="radio" value="0" name="fixedAssetsFundingStructure[is_fully_funded_though_equity]" @if(isset($subModel) && !$isFullyFundingTroughEquity) checked @endisset
