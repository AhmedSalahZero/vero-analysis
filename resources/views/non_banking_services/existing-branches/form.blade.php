            ...
            <div class="kt-portlet__body">
                <div class="row">
                    ...
                    <div class="col-md-2 text-right">
                        <x-show-hide-btn :query="'.existing-branches'"></x-show-hide-btn>
                    </div>
                </div>
                <div class="row">
                    <hr style="flex:1;background-color:lightgray">
                </div>
                <div class="row existing-branches">

                    <div class="form-group row" style="flex:1;">
                        <div class="col-md-12 mt-3" data-repeater-row=".existing-branches">
                            ...
                            <form id="form-id" class="kt-form kt-form--label-right" method="POST" enctype="multipart/form-data" action="{{  isset($disabled) && $disabled ? '#' :  $storeRoute  }}">
                                ...
                                <div id="existingBranches" class="leasing-repeater-parent">
                                    <div class="form-group2  m-form__group2 row">
                                        <div data-repeater-list="existingBranches" class="col-lg-8">

                                            @include('non_banking_services.existing-branches._repeater' , [

                                            'tableId'=>'existingBranches',
                                            'isRepeater'=>true ,
                                            'canAddNewItem'=>true ,
                                            'model'=>$model
