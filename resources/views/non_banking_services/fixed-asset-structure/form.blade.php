            ...
            <div class="kt-portlet__body">
                ...
                <div class="row fixed-asset-names">
                    ...
                    <div class="form-group row" style="flex:1;">
                        <div class="col-md-8 mt-3" data-repeater-row=".fixed-asset-names">
                                ...
                                <div id="fixedAssetNames" class="leasing-repeater-parent">
                                    <div class="form-group2  m-form__group2 row">
                                        <div data-repeater-list="fixedAssetNames" class="col-lg-12">
                                            @include('non_banking_services.fixed-asset-structure._repeater' , [
												'tableId'=>'fixedAssetNames',
												'isRepeater'=>!$inEditMode ,
												'canAddNewItem'=>!$inEditMode ,
												'inEditMode'=>$inEditMode,
												'fixedAssetNames'=>$fixedAssetNames
                                            ])
                                        </div>
                                    </div>
