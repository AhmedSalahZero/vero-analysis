        ...
        <div class="kt-portlet__body">
            <div class="tab-content  kt-margin-t-20">
                ...
                <div class="tab-pane" id="kt_apps_contacts_view_tab_2" role="tabpanel">
                    <x-table :tableTitle="__('Sales Channel Sales Trend Analysis Report')"
                            ...
                            @foreach ($final_report_data as $sales_channel_name => $zoone_data)
                                ...
                                <tr class="group-color text-lg-left  ">
                                    <td colspan="{{ count($total_sales_channels) + 1 }}"><b
                                            class="white-text">{{ __($sales_channel_name) }}</b>
                                    </td>
                                    @foreach ($total_sales_channels as $date => $total)
                                        <td class="hidden"> </td>
                                    @endforeach
                                ...
                                <input type="hidden" id="{{ str_replace(' ', '_', $sales_channel_name) }}_data"
