    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="kt-form kt-form--label-right" method="POST"
                action=@if($name_of_selector_label == 'Sales Discount') {{  route('businessSectors.salesDiscount.analysis.result', $company) }}
                        @elseif (($type == 'averagePrices') || ($type == 'averagePricesProductItems')) {{ route('averagePrices.result', $company) }}
                        @else {{ route('businessSectors.analysis.result', $company)  }}
                        @endif
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            <div class="col-md-{{$column}}">
                                <label>{{ __('Select Business Sectors ( Multi Selection )') }} @include('max-option-span') </label>
                                <div class="kt-input-icon">
                                    <div class="input-group date">
