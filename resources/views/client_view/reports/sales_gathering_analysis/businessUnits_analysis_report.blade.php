...
<div class="kt-portlet kt-portlet--tabs">
    ...
    <div class="kt-portlet__body">
        <div class="tab-content  kt-margin-t-20">
            ...
            <?php
                    array_push($businessUnits_names, 'Total');
                    array_push($businessUnits_names, 'BusinessUnits_Sales_Percentages');
                    ?>
            {{-- <div class="tab-pane " id="kt_apps_contacts_view_tab_1" role="tabpanel">
                    @foreach ($businessUnits_names as $name_of_zone)
                                ...
                                <div class="kt-portlet__body kt-portlet__body--fluid">
                                    <div class="kt-widget12">
                                        <div class="kt-widget12__chart">
                                            <!-- HTML -->
                                            <h4>{{ str_replace('_', ' ', $name_of_zone) . ($name_of_zone == 'BusinessUnits_Sales_Percentages' ? ' Against Total Sales' : ' Sales Trend Analysis Chart') }}
            </h4>
...
<div class="tab-pane active" id="kt_apps_contacts_view_tab_2" role="tabpanel">
    <x-table :tableTitle="__($view_name.' Report')" :tableClass="'kt_table_with_no_pagination'">
        ...
        <tr class="table-active text-center">
            <th class="text-center absorbing-column">{{ __('Business Units') }}</th>
