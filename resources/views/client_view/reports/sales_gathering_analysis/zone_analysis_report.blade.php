                    ...
                    <x-table :tableTitle="__($view_name.' Report')"
                        ...
                        @slot('table_header')
                            <tr class="table-active text-center">
                                {{-- <th>{{ __('Collapse') }}</th> --}}
                                <th class="text-center absorbing-column">{{ __('Zone') }}</th>
                                ...
                                <?php
                                    ...
                                    <tr class="group-color">
                                        {{-- <td class="text-center" style="cursor: pointer;"
                                            onclick="toggleRow('{{ $id }}')"><i
                                                class="row_icon{{ $id }} flaticon2-up white-text"></i>
                                        </td> --}}
                                    ...
                                    <tr class="active-style text-center">
                                        ...
                                        @foreach ($dates as $date)
                                            ...
                                            <td class="text-center active-style">
                                                {{ number_format($zone_channels_data[$date] ?? 0,$decimals) . ($decimals == 0 ? '' : ' %')}}</td>
                                        @endforeach
