    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="kt-form kt-form--label-right" method="POST"
                action={{  $name_of_selector_label == 'Sales Discount' ? route('Items.salesDiscount.analysis.result', $company) : route('Items.analysis.result', $company) }} enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            <div class="col-md-{{$column}}">
                                <label>{{ __('Select Products Items ( Multi Selection )') }} </label>
                                <div class="kt-input-icon">
                                    <div class="input-group date">
                            ...
                            @if ( $name_of_selector_label == 'Sales Discount')
                                ...
                                <div class="col-md-{{$column}}">
                                    <label>{{ __('Select '.$name_of_selector_label.' ( Multi Selection )') }} </label>
                                    <div class="kt-input-icon">
                                        <div class="input-group date">
                            ...
                            @else
                                <div class="col-md-{{$column}}">
                                    <label>{{ __('Select '.$name_of_selector_label.' ') }} <span class="multi_selection">{{__('( Multi Selection )')}}</span></label>
                                    <div class="kt-input-icon">
