					...
					@if(isset(get_defined_vars()['__data']['type']) && get_defined_vars()['__data']['type'] !='averagePrices')
					 <div class="col-md-4  first-interval">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date">
                                    <input type="date" value="{{ getEndYearBasedOnDataUploaded($company)['jan'] }}" name="start_date" required class="form-control trigger-update-select-js" placeholder="Select date" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
