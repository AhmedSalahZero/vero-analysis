    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="kt-form kt-form--label-right" method="POST"
                action= @if($name_of_selector_label == 'Sales Discount') {{ route('products.salesDiscount.analysis.result', $company) }}
                        @elseif ($type == 'averagePricesProductItems') {{ route('averagePrices.result', $company) }}
                        @else {{ route('products.analysis.result', $company)  }}
                        @endif
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            <div class="col-md-{{$column}}">
                                <label>{{ __('Select products ( Multi Selection )') }} @include('max-option-span') </label>
                                <div class="kt-input-icon">
                                    <div class="input-group date">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="kt-input-icon">
                                    <div class="input-group date">
                                        <input type="date" name="end_date" required value="{{date('Y-m-d')}}" max="{{ date('Y-m-d') }}"
