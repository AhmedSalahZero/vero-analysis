        ...
        <div class="kt-portlet__body">
            <div class="tab-content  kt-margin-t-20">
                ...
                <div class="tab-pane" id="kt_apps_contacts_view_tab_2" role="tabpanel">
                    <x-table :tableTitle="__('Country Sales Trend Analysis Report')"
                        ...
                        @slot('table_body')
                            @foreach ($final_report_data as $zone_name => $zoone_data)
                                ...
                                <tr class="group-color text-lg-left  ">
                                    <td colspan="{{ count($total_countries) + 1 }}"><b
                    ...
                    <x-table :tableTitle="__('Country Sales Percentage (%) Against Total Sales')"
                        :tableClass="'kt_table_with_no_pagination_no_search'">
                        @slot('table_header')
                            <tr class="table-active">
                                <th>{{ __('Country') }}</th>
