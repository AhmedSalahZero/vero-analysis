    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="kt-form kt-form--label-right" method="POST"
                action={{ route('categories.sales.analysis.result', $company) }} enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="kt-input-icon">
                                    <div class="input-group date">
                                        <select data-live-search="true" data-actions-box="true" data-max-options="{{ maxOptionsForOneSelector() }}" name="categoriesData[]" required
                                            class="form-control select2-select kt-bootstrap-select kt_bootstrap_select" id="categoriesData"
                                            multiple>
