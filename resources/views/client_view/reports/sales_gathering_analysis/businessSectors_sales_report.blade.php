        ...
        <div class="kt-portlet__body">
            <div class="tab-content  kt-margin-t-20">
                ...
                <div class="tab-pane" id="kt_apps_contacts_view_tab_2" role="tabpanel">
                    <x-table :tableTitle="__('Business Sectors Sales Trend Analysis Report')"
                        ...
                        @slot('table_body')
                            @foreach ($final_report_data as $zone_name => $zoone_data)
                                ...
                                <tr class="group-color text-lg-left  ">
                                    <td colspan="{{ count($total_businessSectors) + 1 }}"><b
                            ...
                            <tr>
                                ...
                                <?php $chart_data = []; ?>
                                @foreach ($total_businessSectors_growth_rates as $date => $total)
                                    <?php
                                    $chart_data[] = [
                                        'date' => date('d-M-Y', strtotime($date)),
                    ...
                    <x-table :tableTitle="__('Business Sectors Sales Percentage (%) Against Total Sales')"
                        :tableClass="'kt_table_with_no_pagination_no_search'">
                        @slot('table_header')
                            <tr class="table-active">
                                <th>{{ __('Business Sectors') }}</th>
    ...
    @foreach ($businessSectors_names as $name_of_zone)
        <script>
            am4core.ready(function() {
                ...
                if("{{ $name_of_zone }}"== 'BusinessSectors_Sales_Percentages'){
