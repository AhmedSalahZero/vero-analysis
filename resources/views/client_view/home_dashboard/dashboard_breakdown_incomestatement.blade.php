        ...
        <form action="{{route('dashboard.breakdown.incomeStatement',$company)}}" method="POST">
            ...
            <div class="form-group row">
                <div class="col-md-4">
                    ...
                    <select class="form-control kt-selectpicker" name="financial_statement_able_id">
                        ...
                        <div class="kt-widget24__details">
                            <span class="kt-widget24__stats kt-font-{{$color}}" style="font-size:1.75rem">
                                ...
                                <span style="color:black !important;">
                                    [ {{ isset($total_of_sales_revenue)&&$total_of_sales_revenue ? number_format($total_of_each_group_with_depreciation / $total_of_sales_revenue  *100 , 2  ) . ' %' : 0 }} ]
                                </span>
                                @endif
                                @php
                                    ...
                                    <x-table :tableClass="'kt_table_with_no_pagination_no_scroll_without_pdf'">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{
                                                                isset($total_of_sales_revenue)&&$total_of_sales_revenue ? number_format($item / $total_of_sales_revenue  * 100 , 2) . ' %' : 0
                                                                }}</td>
                                            @endif
