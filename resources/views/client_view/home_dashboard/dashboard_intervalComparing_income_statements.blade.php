        ...
        <form action="{{route('dashboard.intervalComparing.incomeStatement',$company)}}" method="POST">
              ...
              <div class="form-group row ">
                ...
                <div class="col-md-9">
                    <div class="input-group date" >
                                        <select data-actions-box="true"   data-live-search="true" data-max-options="0" name="types[]" required class="form-control select2-select form-select form-select-2 form-select-solid fw-bolder select-all"
                                             multiple>
            ...
            <div class="form-group row ">
                ...
                <div class="col-md-3">
                    ...
                    <select  data-live-search="true" data-max-options="2" name="income_statement_first_interval" required class="form-control select2-select form-select form-select-2 form-select-solid fw-bolder"
                                             {{-- multiple --}}
                                             >
            ...
            <div class="form-group row ">
                <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                             <label>{{__('Income Statement')}}</label>
                    <select  data-live-search="true" data-max-options="2" name="income_statement_second_interval" required class="form-control select2-select form-select form-select-2 form-select-solid fw-bolder"
                                             {{-- multiple --}}
                                             >
