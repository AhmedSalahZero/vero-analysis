...
<style>
    ...
    table.dataTable tbody tr:hover>.dtfc-fixed-left {
        right: 0 !important;
        background-color: #087383c4 !important;
                                ...
                                <label class="kt-option bg-secondary">
                                    <span class="kt-option__control">
                                        <span class="kt-checkbox kt-checkbox--bold kt-checkbox--brand kt-checkbox--check-bold" checked>
                                            <input class="rows" name="use_modified_targets" type="checkbox" value="1" {{ (($modified_targets['use_modified_targets'])??(old('use_modified_targets'))) == 0 ?: 'checked' }} id="product_item_check_box">
                                            <span></span>
                                        </span>
                                    </span>
