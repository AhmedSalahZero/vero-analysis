            ...
            <div class="col-md-12">
                <div class="kt-portlet kt-portlet--mobile">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <x-table :tableTitle="__('New Product '.$name.' Monthly Sales Target Year ') . date('Y',strtotime($sales_forecast->start_date))" :tableClass="'kt_table_with_no_pagination_no_scroll'">
                            @slot('table_header')
            ...
            <div class="col-md-12">
                <div class="kt-portlet kt-portlet--mobile">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <!--begin: Datatable -->
                        <x-table :tableTitle="__('Total Company Sales Target')" :tableClass="'kt_table_with_no_pagination_no_scroll'">
                            @slot('table_header')
                            <tr class="table-active text-center">
                                <th>{{ __('Dates') }}</th>
