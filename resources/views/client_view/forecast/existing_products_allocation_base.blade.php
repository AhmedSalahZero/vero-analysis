        ...
        <div class="kt-portlet__body">
            ...
            <x-table :tableTitle="__('New Product Items Table')" :tableClass="'kt_table_with_no_pagination'">
                ...
                <tr>
                    ...
                    <td class="text-center active-style">{{ isset($percentages) ? number_format(array_sum($percentages), 2) . ' %'  : 0 }}</td>
                </tr>
        ...
        <div class="kt-portlet__body">
                                ...
                                <label class="kt-option bg-secondary">
                                    <span class="kt-option__control">
                                        <span class="kt-checkbox kt-checkbox--bold kt-checkbox--brand kt-checkbox--check-bold" checked>
                                            <input class="rows" name="use_modified_targets" type="checkbox" value="1" {{ ($existing_allocations_base['use_modified_targets']??(old('use_modified_targets'))) == 0 ?: 'checked' }} id="product_item_check_box">
                                            <span></span>
                                        </span>
                                    </span>
            ...
            <x-table :tableTitle="__($item.' Sales Target Values Table')" :tableClass="'kt_table_with_no_pagination'">
                ...
                <tr>
                    ...
                    <input type="hidden" name="existing_products_target[{{$product_data['item']}}]" value="{{$existing_target_per_product}}">
                    ...
                    <td class="text-center">
                        <input type="number" {{-- name="modify_sales_target[{{ $product_data['item'] }}][value]" --}} placeholder="{{ __('Value') }}" class="modify_sales_target form-control" {{-- value="{{ @$modified_targets['products_modified_targets'][$product_data['item']] }}" --}}>
                    </td>
                    <?php
                                    ...
                                    ?>
                    <td class="text-center light-gray-bg">
                        <input type="number" name="modify_sales_target[{{ $product_data['item'] }}]" placeholder="{{ __('%') }}" class="modify_sales_target_percentage form-control" value="{{$percentage}}">
                    </td>
                    @else
                    @foreach ($sales_targets as $quarter_name => $value)
                    ...
                    <td class="text-center">
                        <input type="number" {{-- name="modify_sales_target[{{ $product_data['item'] }}][{{ $quarter_name }}][value]" --}} placeholder="{{ __('Value') }}" class="modify_sales_target_{{ $quarter_name }} form-control" data-quarter_annual_target="{{ $value }}" {{-- value="{{ @$existing_allocations_base['products_modified_targets'][$product_data['item']][$quarter_name]  }}" --}}>
                    </td>

                    <td class="text-center light-gray-bg">
                        <input type="number" name="modify_sales_target[{{ $product_data['item'] }}][{{ $quarter_name }}]" data-quarter_annual_target="{{ $value }}" value="{{ $existing_allocations_base['allocation_base_percentages'][$product_data['item']][$quarter_name] ?? '' }}" placeholder="{{ __('%') }}" class="modify_sales_target_percentage_{{ $quarter_name }} form-control">
                    </td>
                    @endforeach
                    @endif
                </tr>
