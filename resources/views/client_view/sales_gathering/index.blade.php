...
<div class="row">
    ...
    <form action="{{ route('multipleRowsDelete', [$company, 'SalesGathering']) }}" method="POST">
        @csrf
        <x-table :tableTitle="__('Sales Table')" :tableClass="'kt_table_with_no_pagination'" href="#" :importHref="route('salesGatheringImport',$company)" :exportHref="route('salesGathering.export',$company)" :exportTableHref="route('table.fields.selection.view',[$company,'SalesGathering','sales_gathering'])"
        :truncateHref="route('truncate',[$company,'SalesGathering'])">
            @slot('table_header')
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-lg-12 ">
