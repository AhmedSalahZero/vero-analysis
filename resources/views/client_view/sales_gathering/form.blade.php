...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form kt-form--label-right" method="POST" action={{(request()->is('*/edit'))  ? route('salesGathering.update',[$company,$salesGathering]): route('salesGathering.store',[$company] )}}   enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="kt-input-icon">
                                    <input type="text" name="customer_name" value="{{$salesGathering->customer_name}}" class="form-control" placeholder="{{__('Customer Name')}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="kt-input-icon">
                                    <input type="text" name="business_sector" value="{{$salesGathering->business_sector}}"  class="form-control" placeholder="{{__('Business Sector')}}">
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <div class="kt-input-icon">
                                    <input type="number" step="any" step="any" name="invoice_amount" value="{{$salesGathering->invoice_amount}}" id="invoice_amount" class="form-control" placeholder="{{__('Invoice Amount')}}">
                                ...
                                <div class="kt-input-icon">
                                    <div class="input-group date">
                                        <select name="currency" class="form-control">
                                            ...
                                            <option value="EGP"  {{$salesGathering->currency !== 'EGP' ?: 'selected'}} >{{__('EGP')}}</option>
                                            <option value="USD"  {{$salesGathering->currency !== 'USD' ?: 'selected'}} >{{__('USD')}}</option>
                                            <option value="EURO" {{$salesGathering->currency !== 'EURO' ?: 'selected'}} >{{__('EURO')}}</option>
                                            <option value="GBP"  {{$salesGathering->currency !== 'GBP' ?: 'selected'}} >{{__('GBP')}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <div class="kt-input-icon">
                                    <input type="number" step="any" step="any" name="advance_payment_amount" value="{{$salesGathering->advance_payment_amount}}"  id="advance_payment_amount" class="form-control" placeholder="{{__('Advance Payment Amount')}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="kt-input-icon">
                                    <input type="number" step="any" step="any" name="vat_amount" value="{{$salesGathering->vat_amount}}"  id="vat_amount" class="form-control" placeholder="{{__('VAT Amount')}}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-3">
                                ...
                                <select class="form-control kt-selectpicker" name="deduction_id_one">
                                    ...
                                    @foreach ($deductions as $item)
                                        <option value="{{$item->id}}" {{$salesGathering->deduction_id_one !=  $item->id ?: 'selected'}}>{{__($item->viewing_name)}}</option>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="kt-input-icon">
                                    <input type="number" step="any" name="deduction_amount_one" value="{{$salesGathering->deduction_amount_one}}" min="0" class="form-control deduction_amounts" placeholder="{{__('Deduction Amount')}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control kt-selectpicker" name="deduction_id_two">
                                    <option value="" >{{__('Select')}}</option>
                                    @foreach ($deductions as $item)
                                        <option value="{{$item->id}}" {{$salesGathering->deduction_id_two !=  $item->id ?: 'selected'}}>{{__($item->viewing_name)}}</option>
                            ...
                            <div class="col-md-3">
                                <label>{{__('Deduction Amount')}} <span class="required">*</span></label>
                                <div class="kt-input-icon">
                                    <input type="number" step="any" name="deduction_amount_two" value="{{$salesGathering->deduction_amount_two}}" min="0" class="form-control deduction_amounts" placeholder="{{__('Deduction Amount')}}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-3">
                                ...
                                <select class="form-control kt-selectpicker" name="deduction_id_three">
                                    <option value="" >{{__('Select')}}</option>
                                    @foreach ($deductions as $item)
                                        <option value="{{$item->id}}"  {{$salesGathering->deduction_id_three !=  $item->id ?: 'selected'}}>{{__($item->viewing_name)}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3">
                                <label>{{__('Deduction Amount')}} <span class="required">*</span></label>
                                <div class="kt-input-icon">
                                    <input type="number" step="any" name="deduction_amount_three" value="{{$salesGathering->deduction_amount_three}}" min="0" class="form-control deduction_amounts" placeholder="{{__('Deduction Amount')}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control kt-selectpicker" name="deduction_id_four">
                                    <option value="" >{{__('Select')}}</option>
                                    @foreach ($deductions as $item)
                                        <option value="{{$item->id}}"  {{$salesGathering->deduction_id_four !=  $item->id ?: 'selected'}}>{{__($item->viewing_name)}}</option>
                            ...
                            <div class="col-md-3">
                                <label>{{__('Deduction Amount')}} <span class="required">*</span></label>
                                <div class="kt-input-icon">
                                    <input type="number" step="any" name="deduction_amount_four" value="{{$salesGathering->deduction_amount_four}}" min="0" class="form-control deduction_amounts" placeholder="{{__('Deduction Amount')}}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-3">
                                ...
                                <select class="form-control kt-selectpicker" name="deduction_id_five">
                                    <option value="" >{{__('Select')}}</option>
                                    @foreach ($deductions as $item)
                                        <option value="{{$item->id}}"  {{$salesGathering->deduction_id_five !=  $item->id ?: 'selected'}}>{{__($item->viewing_name)}}</option>
                            ...
                            <div class="col-md-3">
                                <label>{{__('Deduction Amount')}} <span class="required">*</span></label>
                                <div class="kt-input-icon">
                                    <input type="number" step="any" name="deduction_amount_five" value="{{$salesGathering->deduction_amount_five}}" min="0" class="form-control deduction_amounts" placeholder="{{__('Deduction Amount')}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control kt-selectpicker" name="deduction_id_six">
                                    <option value="" >{{__('Select')}}</option>
                                    @foreach ($deductions as $item)
                                        <option value="{{$item->id}}"  {{$salesGathering->deduction_id_six !=  $item->id ?: 'selected'}}>{{__($item->viewing_name)}}</option>
                            ...
                            <div class="col-md-3">
                                <label>{{__('Deduction Amount')}} <span class="required">*</span></label>
                                <div class="kt-input-icon">
                                    <input type="number" step="any" name="deduction_amount_six" value="{{$salesGathering->deduction_amount_six}}" min="0" class="form-control deduction_amounts" placeholder="{{__('Deduction Amount')}}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <div class="kt-input-icon">
                                    <input type="number" step="any" readonly step="any" id="total_deduction" name="total_deduction" value="{{$salesGathering->total_deduction}}" min="0" class="form-control" placeholder="{{__('Total Deductions')}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="kt-input-icon">
                                    <input type="number" step="any" readonly step="any" name="invoice_net_amount" value="{{$salesGathering->invoice_net_amount}}" id="invoice_net_amount" min="0" class="form-control" placeholder="{{__('Invoice Net Amount')}}">
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <div class="kt-input-icon">
                                    <input type="number" step="any" name="invoices_due_notification_days" value="{{$salesGathering->invoices_due_notification_days}}" class="form-control" placeholder="{{__('Invoices Due Notification Days')}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="kt-input-icon">
                                    <input type="number" step="any" name="past_due_invoices_notification_days" value="{{$salesGathering->past_due_invoices_notification_days}}" class="form-control" placeholder="{{__('Past Due Invoices Notification Days')}}">
