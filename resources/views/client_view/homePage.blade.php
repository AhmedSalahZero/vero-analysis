            ...
            <div class="kt-portlet__body">
                <div class="kt-iconbox__body">
                    <div class="kt-iconbox__desc">
                        ...
                        </svg> Do you want to upload new data?
                        </h3>
                        <br><br>
                        <div class="kt-iconbox__content d-flex align-items-start flex-column">
                            {{-- <ul class="mb-auto p-2">
                                <li> <h4> {{ __("Sales Data") }}  <a href="{{route('salesGathering.index',$company)}}" class="btn btn-label-info btn-pill"> <b>Go</b></a> </h4></li>
                                <li> <h4> {{ __("Inventory Data") }}  <a href="{{route('inventoryStatement.index',$company)}}" class="btn btn-label-info btn-pill"><b>Go</b></a> </h4></li>
                            </ul> --}}
                            <div class="kt-portlet__body">
                                <div class="kt-list-timeline">
                                    <div class="kt-list-timeline__items">
                                        ...
                                        <div class="kt-list-timeline__item ">
                                            ...
                                            <span class="kt-list-timeline__text"> <h4> {{ __("Sales Data") }} </h4></span>
                                            <span class="kt-list-timeline__time "> <a href="{{route('salesGathering.index',$company)}}" class="btn btn-outline-info"> <b>Go</b></a></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="kt-list-timeline__items">
                                        <div class="kt-list-timeline__item">
                                            <span class="kt-list-timeline__badge kt-list-timeline__badge--brand"></span>
                                            <span class="kt-list-timeline__text"> <h4> {{ __("Income Statement  ") }} </h4>  </span>
                                            ...
                                            <span class="kt-list-timeline__time disable"> <a href="{{ route('admin.view.income.statement',['company'=>$company->id]) }}" class="btn btn-outline-info"><b>{{ __('GO') }}</b></a></span>
                                        </div>
                                    </div>
                                    @endif 
                                </div>
                ...
                <div class="kt-widget6__action kt-align-left" >
                    <a href="#" onclick="return false;"   id="skip" class="btn btn-outline-info"><b>Skip</b></a>
                </div>
            </div>
        </div>
    {{-- </div> --}}
            ...
            <div class="kt-portlet__body">
                <div class="kt-iconbox__body">
                    <div class="kt-iconbox__desc">
                        ...
                        <div class="kt-iconbox__content d-flex align-items-start flex-column">
                            {{-- <ul class="mb-auto p-2">
                                <li> <h4> {{ __("Sales Dashboard") }}  <a href="{{ route('dashboard', $company) }}" class="btn btn-label-info btn-pill"> <b>Go</b></a> </h4></li>
                                <li> <h4> {{ __("Sales Breakdown Analysis") }}  <a href="{{route('sales.breakdown.analysis',$company)}}" class="btn btn-label-info btn-pill"><b>Go</b></a> </h4></li>
                                <li> <h4> {{ __("Sales Trend Analysis") }}  <a href="{{route('sales.trend.analysis',$company)}}" class="btn btn-label-info btn-pill"><b>Go</b></a> </h4></li>
                                <li> <h4> {{ __("Sales Report") }}  <a href="{{route('salesReport.view',$company)}}" class="btn btn-label-info btn-pill"><b>Go</b></a> </h4></li>
                            </ul> --}}
                            ...
                            <div class="kt-portlet__body">
                                <div class="kt-list-timeline">
                                    <div class="kt-list-timeline__items">
                                        ...
                                        <div class="kt-list-timeline__item">
                                            <span class="kt-list-timeline__badge kt-list-timeline__badge--brand"></span>
                                            <span class="kt-list-timeline__text"> <h4> {{ __("Sales Dashboard") }} </h4></span>
                                    ...
                                    <div class="kt-list-timeline__items">
                                        ...
                                        <div class="kt-list-timeline__item">
                                            <span class="kt-list-timeline__badge kt-list-timeline__badge--brand"></span>
                                            <span class="kt-list-timeline__text"> <h4> {{ __("Sales Breakdown Analysis") }} </h4></span>
                                    ...
                                    <div class="kt-list-timeline__items">
                                        ...
                                        <div class="kt-list-timeline__item">
                                            <span class="kt-list-timeline__badge kt-list-timeline__badge--brand"></span>
                                            <span class="kt-list-timeline__text"> <h4> {{ __("Sales Trend Analysis") }} </h4></span>
                                    ...
                                    <div class="kt-list-timeline__items">
                                        ...
                                        <div class="kt-list-timeline__item">
                                            <span class="kt-list-timeline__badge kt-list-timeline__badge--brand"></span>
                                            <span class="kt-list-timeline__text"> <h4> {{ __("Sales Report") }} </h4></span>
