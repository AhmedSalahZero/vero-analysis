...
')
     ...
     */ 
         ...
         * @param string $idAttrOrFunction
         * @param string $titleAttrOrFunction
         * @static 
         */ 
        public static function formattedForSelect($isFunction, $idAttrOrFunction, $titleAttrOrFunction)
        {
         ...
         * @static 
         */ 
        public static function filterByStartDate($startDate, $endDate)
        {
                        return \Illuminate\Support\Collection::filterByStartDate($startDate, $endDate);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function filterByTransactionDate($startDate, $endDate)
        {
                        return \Illuminate\Support\Collection::filterByTransactionDate($startDate, $endDate);
        }
                    /**
         * 
         *
