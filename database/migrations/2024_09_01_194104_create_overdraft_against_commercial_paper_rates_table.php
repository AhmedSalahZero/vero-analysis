...
class CreateOverdraftAgainstCommercialPaperRatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('overdraft_against_commercial_paper_rates', function (Blueprint $table) {
            $table->id();
