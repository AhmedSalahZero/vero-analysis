...
class CreateQuantitySecondExistingProductsAllocationBaseTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('quantity_second_existing_products_allocation_base', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('quantity_second_existing_products_allocation_base');
    }
}
