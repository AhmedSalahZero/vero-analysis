...
class CreateSecondExistingProductsAllocationBaseTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('second_existing_products_allocation_base', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('second_existing_products_allocation_base');
    }
}
