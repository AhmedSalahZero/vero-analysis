...
class CreateExistingProductsAllocationBaseTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('existing_products_allocation_base', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('existing_products_allocation_base');
    }
}
