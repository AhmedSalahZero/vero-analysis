...
class CreateSecondAllocationSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('second_allocation_settings', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('second_allocation_settings');
    }
}
