...
class CreateFullySecuredOverdraftBankStatementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fully_secured_overdraft_bank_statements', function (Blueprint $table) {
            ...
            $table->unsignedInteger('fully_secured_overdraft_id');
    ...
    {
        Schema::dropIfExists('fully_secured_overdraft_bank_statements');
    }
}
