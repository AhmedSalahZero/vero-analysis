...
var KTLayout = function() {
	...
	var initSecondHeader = function() {
        var tmp;
        var headerEl = KTUtil.get('second_kt_header');
        var options = {
            classic: {
                desktop: true,
                mobile: false
        ...
        header = new KTHeader('second_kt_header', options);
    }
	...
	var initSecondHeaderMenu = function() {
        // init aside left offcanvas
        headerMenuOffcanvas = new KTOffcanvas('second_kt_header_menu_wrapper', {
            overlay: true,
            baseClass: 'kt-header-menu-wrapper',
            closeBy: 'kt_header_menu_mobile_close_btn',
            toggleBy: {
        ...
        headerMenu = new KTMenu('second_kt_header_menu', {
            submenu: {
                desktop: 'dropdown',
                tablet: 'accordion',
                mobile: 'accordion'
	...
	// Header Topbar
    var initSecondHeaderTopbar = function() {
        mobileHeaderTopbarToggle = new KTToggle('second_kt_header_mobile_topbar_toggler', {
            target: 'body',
            targetState: 'kt-header__topbar--mobile-on',
            togglerState: 'kt-header-mobile__toolbar-topbar-toggler--active'
        });
    ...
    return {
		...
		secondHeader: function() {
            initSecondHeader();
            initSecondHeaderMenu();
            initSecondHeaderTopbar();
