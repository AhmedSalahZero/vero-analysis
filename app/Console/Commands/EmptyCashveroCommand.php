...
class EmptyCashveroCommand extends Command
{
    ...
    public function handle()
    {
		...
		foreach([
			...
			,'clean_overdraft_bank_statements','clean_overdraft_withdrawals','contracts',
...
, "lg_opening_balances"
, "loans",'money_received','money_payments','opening_balances','outgoing_transfers','outstanding_breakdowns','overdraft_against_assignment_of_contract_bank_statements','overdraft_against_assignment_of_contract_limits','overdraft_against_assignment_of_contract_withdrawals','overdraft_against_commercial_paper_bank_statements','overdraft_against_commercial_paper_limits','overdraft_against_commercial_paper_withdrawals','payable_cheques','payment_settlements','settlements'
