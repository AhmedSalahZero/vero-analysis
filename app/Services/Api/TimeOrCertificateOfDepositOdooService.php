...
class TimeOrCertificateOfDepositOdooService
{
	...
	public function createAndPostJournalEntry(string $date , float $amount  , int $odooCurrencyId , int $creditJournalId,int $creditOdooAccountId, int $debitOdooAccountId   , ?string $ref , ?int $partnerId ,?string $message ) 
    {
			$id = null ;  // in edit mode 
            $journalEntryData = $this->getDataFormatted($date,$amount,$odooCurrencyId,$creditJournalId,$debitOdooAccountId,$creditOdooAccountId,$ref,$partnerId,$message,$id) ;
	...
	protected function getDataFormatted(string $date , float $amount  , int $odooCurrencyId , int $creditJournalId,int $creditOdooAccountId, int $debitOdooAccountId   , ?string $ref , ?int $partnerId ,?string $message , int $id = null ):array 
	{
