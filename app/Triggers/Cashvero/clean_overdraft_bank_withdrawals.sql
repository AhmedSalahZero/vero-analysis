	drop trigger if exists refresh_calculation_before_insert_clean_overdraft_withdrawals ;
	delimiter // 
	create  trigger refresh_calculation_before_insert_clean_overdraft_withdrawals before insert on `clean_overdraft_bank_statements` for each row 
	begin 
