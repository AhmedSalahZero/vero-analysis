				...
				delimiter // 
				create procedure calculate_limit_overdraft_against_commercial_bank_statements(in _overdraft_against_commercial_paper_id int , in _company_id integer , out _limit decimal(14,2))
				begin
