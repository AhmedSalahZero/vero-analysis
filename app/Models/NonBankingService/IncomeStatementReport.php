...
class IncomeStatementReport extends Model
{
    ...
    protected $casts = [
            ...
            'portfolio-mortgage_monthly_ecl_expense'=>'array',
            'portfolio-mortgage_accumulated_ecl_expense'=>'array',
            'microfinance_bank_interest'=>'array',
            'microfinance_monthly_ecl_expense'=>'array',
            'microfinance_accumulated_ecl_expense'=>'array',
