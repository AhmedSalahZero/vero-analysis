...
trait FinancialStatementAbleRelation
{
	...
	public function subItems(): BelongsToMany
	{
		...
		return $this->belongsToMany(
			...
			->withPivot(['sub_item_name', 'sub_item_type', 'created_from', 'payload', 'is_depreciation_or_amortization', 'has_collection_policy', 'collection_policy_type', 'collection_policy_value', 'is_quantity', 'can_be_quantity','is_value_quantity_price', 'actual_dates', 'percentage_or_fixed', 'can_be_percentage_or_fixed', 'repeating_fixed_value', 'percentage_value', 'cost_of_unit_value', 'is_cost_of_unit_of', 'is_financial_expense', 'is_financial_income', 'is_percentage_of','receivable_or_payment','ordered']);
	}
