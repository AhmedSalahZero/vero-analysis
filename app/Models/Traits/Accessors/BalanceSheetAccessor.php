...
trait BalanceSheetAccessor
{
    ...
    public function hasMainRowPayload(int $balanceSheetItemId): bool
    {
        return $this->subItems()->wherePivot('balance_sheet_item_id', $balanceSheetItemId)->wherePivot('sub_item_name', null)->exists();
    }
