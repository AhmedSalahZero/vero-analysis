...
trait CashFlowStatementAccessor
{
    ...
    public function hasMainRowPayload(int $cashFlowStatementItemId): bool
    {
        return $this->subItems()->wherePivot('cash_flow_statement_item_id', $cashFlowStatementItemId)->wherePivot('sub_item_name', null)->exists();
    }
