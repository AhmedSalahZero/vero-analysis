...
class IntervalsComparingReport
{
    ...
    public function result(Request $request, Company $company,$result='view')
    {
        ...
        if ($result == 'view') {
            ...
            return view('client_view.reports.sales_gathering_analysis.interval_comparing.sales_report',compact('last_date','type','view_name','dates','company','result_for_interval_one','result_for_interval_two','count_result_for_interval_one','count_result_for_interval_two'));
        }else{
            // dd('q');
