    ...
    public function salesBreakdownAnalysisResult(Request $request, Company $company,IncomeStatement $incomeStatement ,$result='view',$calculated_report_data = null)
    {
        ...
        $report_count_data = [];
          ...
          $type = $request->type ;
            ...
            $report_data = formatReportDataForDashBoard($incomeStatement->duration_type , $incomeStatement->start_from ,$incomeStatement->subItems->sortBy('id'),$dates['start_date'] , $dates['end_date']);
