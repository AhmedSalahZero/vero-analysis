...
class IncomeStatementBreakdownAgainstAnalysisReport
{
	...
	public function salesBreakdownAnalysisResult(Request $request, Company $company, IncomeStatement $incomeStatement, $result = 'view', $calculated_report_data = null)
	{
		...
		$report_data = formatReportDataForDashBoard($incomeStatement->duration_type, $incomeStatement->start_from, $incomeStatement->subItems->sortBy('id'), $dates['start_date'], $dates['end_date'], 'actual');
