...
class HomeController extends Controller
{
	...
	public function incomeStatementDashboard(Request $request, Company $company)
	{
		...
		//     " . $company->id  
		// ));
		//  $incomeStatement = IncomeStatement::find($request->get('financial_statement_able_id')) ?: IncomeStatement::where('company_id',$company->id)->latest()->first();
		//  if(!$incomeStatement){
	...
	public function dashboardBreakdownIncomeStatementAnalysis(Request $request, Company $company, $incomeStatementID = null)
	{
		...
		$incomeStatement = IncomeStatement::find($request->get('financial_statement_able_id') ?: $incomeStatementID) ?: IncomeStatement::where('company_id', $company->id)->latest()->first();
