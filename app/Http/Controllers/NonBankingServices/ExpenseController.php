...
class ExpenseController extends Controller
{
    ...
    public function index(Company $company , Request $request){
		...
		// $expenseNames =  $expenseNames->filterByDateColumn('study_start_date',$startDate,$endDate) ;
	...
	public function create(Company $company , Request $request){
		...
		return view('non_banking_services.expense-structure.form', $this->getViewVars($company));
	}
	...
	public function destroy(Request $request,Company  $company , ExpenseName $expenseName  ){
		$expenseName->delete();
