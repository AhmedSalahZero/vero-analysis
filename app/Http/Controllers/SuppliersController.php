...
class SuppliersController
{
	...
	public function index(Company $company,Request $request)
	{
		...
		$supplierStartDate = $filterDates[Partner::CUSTOMERS]['startDate'] ?? null ;
		$supplierEndDate = $filterDates[Partner::CUSTOMERS]['endDate'] ?? null ;
		$suppliers = $company->suppliers ;
		$suppliers =  $suppliers->filterByCreatedAt($supplierStartDate,$supplierEndDate) ;
		$suppliers =  $currentType == Partner::CUSTOMERS ? $this->applyFilter($request,$suppliers):$suppliers ;
