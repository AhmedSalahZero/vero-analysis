...
{
	public   function calculateMonthsDurationPerYear(string $itemStartDate, string $studyEndDate, float $studyDuration)
	{
		return  $this->getStudyYears($studyEndDate, $itemStartDate, (($studyDuration * 12) - 1), 'years');
	}
